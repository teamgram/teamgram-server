...
require (
	...
	github.com/teamgram/marmota v0.1.14
	github.com/teamgram/proto v0.150.1
...
replace github.com/zeromicro/go-zero v1.4.4 => github.com/teamgram/go-zero v0.0.0-20230305144425-83dec8e5437d
