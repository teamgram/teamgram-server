...
import (
	...
	"github.com/teamgooo/teamgooo-server/pkg/net/kitex/codec/echo/echo2/internal/server/tg/service"
...
var configFile = flag.String("f", "etc/echo2.yaml", "the config file")
...
func (s *Server) Initialize() error {
	...
	s.kitexSrv = kitex.MustNewServer(
		...
		func(s server.Server) error {
			return echo2service.RegisterService(s, service.New(ctx))
		})
