...
CREATE TABLE IF NOT EXISTS `canonical_messages` (
  ...
  `message_attrs_schema_version` int NOT NULL DEFAULT '0',
  `message_attrs_payload` blob,
  `forward_ref_schema_version` int NOT NULL DEFAULT '0',
  `forward_ref_payload` blob,
...
CREATE TABLE IF NOT EXISTS `delivery_failed_operations` (
  ...
  `replayed_at` bigint NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `message_read_outbox` (
  ...
  `read_outbox_max_date` bigint NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `user_pts_state` (
  `user_id` bigint NOT NULL,
  `pts` bigint NOT NULL,
  `pts_updated_at` bigint NOT NULL DEFAULT '0',
