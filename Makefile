...
msg:
	@echo "build msg..."
	@go build -ldflags ${ldflags} -o teamgramd/bin/msg -tags=jsoniter app/messenger/msg/msg/cmd/msg/*.go

inbox:
	@echo "build inbox..."
	@go build -ldflags ${ldflags} -o teamgramd/bin/inbox -tags=jsoniter app/messenger/msg/inbox/cmd/inbox/*.go
