    ...
    switch clazzId := iface.GetClazzIDByName(ClazzName_userupdates_processUserOperation, int(layer)); clazzId {
        case 0xc200ea59:
            x.PutClazzID(0xc200ea59)
			  ...
			  if m.Operation == nil { return fmt.Errorf("unable to encode userupdates_processUserOperation#0xc200ea59: field operation is nil") }
if err := m.Operation.Encode(x, layer); err != nil { return fmt.Errorf("unable to encode userupdates_processUserOperation#0xc200ea59: field operation: %w", err) }
...
func (m *TLUserupdatesProcessUserOperation) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
        ...
        if err != nil { return fmt.Errorf("unable to decode userupdates_processUserOperation: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0xc200ea59:
              
    m.Operation, err = DecodeUserOperationClazz(d)
    if err != nil { return fmt.Errorf("unable to decode userupdates_processUserOperation#0xc200ea59: field operation: %w", err) }
...
func (m *TLUserupdatesGetOperationResult) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_getOperationResult: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x47a995d1:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getOperationResult#0x47a995d1: field user_id: %w", err) }
              m.OperationId, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userupdates_getOperationResult#0x47a995d1: field operation_id: %w", err) }
              m.PayloadHash, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode userupdates_getOperationResult#0x47a995d1: field payload_hash: %w", err) } 
...
func (m *TLUserupdatesGetState) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_getState: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x3bbbad80:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getState#0x3bbbad80: field user_id: %w", err) }
              m.AuthKeyId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getState#0x3bbbad80: field auth_key_id: %w", err) }
        ...
        case 0x38cdd9fc:
            ...
            var getFlags = func() uint32 {
			 ...
			 // set flags
               ...
               x.PutInt64(m.AuthKeyId)
               x.PutInt64(m.Pts)
              if m.PtsTotalLimit != nil { x.PutInt32(*m.PtsTotalLimit) }

              if m.Date != nil { x.PutInt64(*m.Date) }
...
func (m *TLUserupdatesGetDifference) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_getDifference: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x38cdd9fc:
             flags, err := d.Uint32()
            if err != nil { return fmt.Errorf("unable to decode userupdates_getDifference: field flags: %w", err) }
            _ = flags
			  m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getDifference#0x38cdd9fc: field user_id: %w", err) }
              m.AuthKeyId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getDifference#0x38cdd9fc: field auth_key_id: %w", err) }
              m.Pts, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getDifference#0x38cdd9fc: field pts: %w", err) }
              if (flags & (1 << 0)) != 0 {
    m.PtsTotalLimit = new(int32)
    *m.PtsTotalLimit, err = d.Int32()
    if err != nil { return fmt.Errorf("unable to decode userupdates_getDifference#0x38cdd9fc: field pts_total_limit: %w", err) }
}
              if (flags & (1 << 1)) != 0 { m.Date = new(int64); *m.Date, err = d.Int64(); if err != nil { return fmt.Errorf("unable to decode userupdates_getDifference#0x38cdd9fc: field date: %w", err) } }
...
func (m *TLUserupdatesListDialogs) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_listDialogs: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x53638fcc:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_listDialogs#0x53638fcc: field user_id: %w", err) }
              m.TopMessageDate, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_listDialogs#0x53638fcc: field top_message_date: %w", err) }
              m.TopPeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_listDialogs#0x53638fcc: field top_peer_seq: %w", err) }
              m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_listDialogs#0x53638fcc: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_listDialogs#0x53638fcc: field peer_id: %w", err) }
              m.Limit, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_listDialogs#0x53638fcc: field limit: %w", err) }
...
func (m *TLUserupdatesGetDialogsByPeers) Encode(x *bin.Encoder, layer int32) error {
    ...
    if err := iface.EncodeObjectList(x, m.Peers, layer); err != nil { return fmt.Errorf("unable to encode userupdates_getDialogsByPeers#0xc6a9626f: field peers: %w", err) }
...
func (m *TLUserupdatesGetDialogsByPeers) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_getDialogsByPeers: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0xc6a9626f:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getDialogsByPeers#0xc6a9626f: field user_id: %w", err) }
                 l2, err3 := d.VectorHeader()
    if err3 != nil { return fmt.Errorf("unable to decode userupdates_getDialogsByPeers#0xc6a9626f: field peers: %w", err3) }
...
func (m *TLUserupdatesGetDialogCount) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_getDialogCount: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x12060b16:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getDialogCount#0x12060b16: field user_id: %w", err) }
...
func (m *TLUserupdatesGetMessageViewsByPeerSeqs) Encode(x *bin.Encoder, layer int32) error {
    ...
    if err := iface.EncodeObjectList(x, m.Peers, layer); err != nil { return fmt.Errorf("unable to encode userupdates_getMessageViewsByPeerSeqs#0x528a3e52: field peers: %w", err) }
...
func (m *TLUserupdatesGetMessageViewsByPeerSeqs) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_getMessageViewsByPeerSeqs: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x528a3e52:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getMessageViewsByPeerSeqs#0x528a3e52: field user_id: %w", err) }
                 l2, err3 := d.VectorHeader()
    if err3 != nil { return fmt.Errorf("unable to decode userupdates_getMessageViewsByPeerSeqs#0x528a3e52: field peers: %w", err3) }
    if l2 > bin.MaxVectorLen {
 ...
 // TLUserupdatesGetOutboxReadDate <--
type TLUserupdatesGetOutboxReadDate struct {
    ClazzID uint32 `json:"_id"`
UserId int64 `json:"user_id"`
PeerType int32 `json:"peer_type"`
PeerId int64 `json:"peer_id"`
...
func (m *TLUserupdatesGetOutboxReadDate) String() string {
    return iface.DebugStringWithName(ClazzName_userupdates_getOutboxReadDate, m)
}

// Encode <--
func (m *TLUserupdatesGetOutboxReadDate) Encode(x *bin.Encoder, layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_userupdates_getOutboxReadDate, int(layer)); clazzId {
        case 0x56fb4ad9:
            x.PutClazzID(0x56fb4ad9)
            ...
            return nil
        default:
        return fmt.Errorf("unable to encode userupdates_getOutboxReadDate: unsupported layer %d", layer)
    }
}

// Decode <--
func (m *TLUserupdatesGetOutboxReadDate) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_getOutboxReadDate: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x56fb4ad9:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getOutboxReadDate#0x56fb4ad9: field user_id: %w", err) }
              m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_getOutboxReadDate#0x56fb4ad9: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_getOutboxReadDate#0x56fb4ad9: field peer_id: %w", err) }
              m.MsgId, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_getOutboxReadDate#0x56fb4ad9: field msg_id: %w", err) }
            
            return nil
        default:
        return fmt.Errorf("unable to decode userupdates_getOutboxReadDate: invalid constructor %x", m.ClazzID)
    }
}
...
func (m *TLUserupdatesAppendDialogAuthSeqSideEffect) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0x170844e5:
             flags, err := d.Uint32()
            if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect: field flags: %w", err) }
            _ = flags
			  m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field user_id: %w", err) }
              m.SourcePermAuthKeyId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field source_perm_auth_key_id: %w", err) }
              m.OperationId, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field operation_id: %w", err) }
              m.TargetAuthPolicy, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field target_auth_policy: %w", err) }
              m.PublicUpdateType, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field public_update_type: %w", err) }
              m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field peer_id: %w", err) }
              m.PayloadSchemaVersion, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field payload_schema_version: %w", err) }
              m.Payload, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field payload: %w", err) } 
              m.PayloadHash, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogAuthSeqSideEffect#0x170844e5: field payload_hash: %w", err) } 
...
func (m *TLUserupdatesAppendDialogPtsSideEffect) Decode(d *bin.Decoder) (err error) {
	if m.ClazzID == 0 {
		m.ClazzID, err = d.ClazzID()
        if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect: constructor: %w", err) }
	}
    switch m.ClazzID {
        case 0xe93427fd:
             flags, err := d.Uint32()
            if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect: field flags: %w", err) }
            _ = flags
			  m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field user_id: %w", err) }
              m.SourcePermAuthKeyId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field source_perm_auth_key_id: %w", err) }
              m.OperationId, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field operation_id: %w", err) }
              m.TargetAuthPolicy, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field target_auth_policy: %w", err) }
              m.PublicUpdateType, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field public_update_type: %w", err) }
              m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field peer_id: %w", err) }
              m.PayloadSchemaVersion, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field payload_schema_version: %w", err) }
              m.Payload, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field payload: %w", err) } 
              m.PayloadHash, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode userupdates_appendDialogPtsSideEffect#0xe93427fd: field payload_hash: %w", err) } 
...
type RPCUserupdates interface {
    ...
    UserupdatesGetOutboxReadDate(ctx context.Context, in *TLUserupdatesGetOutboxReadDate) (*tg.OutboxReadDate, error)
