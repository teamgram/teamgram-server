...
func NewServer(handler userupdates.RPCUserupdates, opts ...server.Option) server.Server {
...
func RegisterService(svr server.Server, handler userupdates.RPCUserupdates, opts ...server.RegisterOption) error {
