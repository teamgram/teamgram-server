...
func (m *TLDialogProjection) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_dialogProjection, int(layer)); clazzId {
        case 0xb9bc23fd:
              if err := iface.ValidateRequiredBytes("dialog_payload", m.DialogPayload); err != nil { return err }
...
func (m *TLDialogProjection) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0xb9bc23fd:
             flags, err := d.Uint32()
            if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field flags: %w", err) }
            _ = flags
			  m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field peer_id: %w", err) }
              m.TopPeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field top_peer_seq: %w", err) }
              m.TopCanonicalMessageId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field top_canonical_message_id: %w", err) }
              m.TopMessageDate, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field top_message_date: %w", err) }
              m.TopMessageStatus, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field top_message_status: %w", err) }
              m.ReadInboxMaxPeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field read_inbox_max_peer_seq: %w", err) }
              m.ReadOutboxMaxPeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field read_outbox_max_peer_seq: %w", err) }
              m.UnreadCount, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field unread_count: %w", err) }
              m.UnreadMentionsCount, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field unread_mentions_count: %w", err) }
              m.UnreadReactionsCount, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field unread_reactions_count: %w", err) }
             if (flags & (1 << 0)) != 0 { m.UnreadMark = true }
              m.PinnedPeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field pinned_peer_seq: %w", err) }
              m.PinnedCanonicalMessageId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field pinned_canonical_message_id: %w", err) }
             if (flags & (1 << 1)) != 0 { m.HasScheduled = true }
              m.AvailableMinPeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field available_min_peer_seq: %w", err) }
              m.LastPts, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field last_pts: %w", err) }
              m.LastPtsAt, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field last_pts_at: %w", err) }
              m.DialogSchemaVersion, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field dialog_schema_version: %w", err) }
              m.DialogPayload, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode dialogProjection#0xb9bc23fd: field dialog_payload: %w", err) } 
...
func (m *TLDialogProjectionList) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_dialogProjectionList, int(layer)); clazzId {
        case 0x4e60f01f:
                  if err := iface.ValidateRequiredSlice("projections", m.Projections); err != nil { return err }

              if err := iface.ValidateRequiredObject("exhausted", m.Exhausted); err != nil { return err }
...
func (m *TLDialogProjectionList) Encode(x *bin.Encoder, layer int32) error {
    ...
    if err := iface.EncodeObjectList(x, m.Projections, layer); err != nil { return fmt.Errorf("unable to encode dialogProjectionList#0x4e60f01f: field projections: %w", err) }

               x.PutInt64(m.NextTopMessageDate)
               x.PutInt64(m.NextTopPeerSeq)
               x.PutInt32(m.NextPeerType)
               x.PutInt64(m.NextPeerId)
              if m.Exhausted == nil { return fmt.Errorf("unable to encode dialogProjectionList#0x4e60f01f: field exhausted is nil") }
if err := m.Exhausted.Encode(x, layer); err != nil { return fmt.Errorf("unable to encode dialogProjectionList#0x4e60f01f: field exhausted: %w", err) }
...
func (m *TLDialogProjectionList) Decode(d *bin.Decoder) (err error) {
    ...
    if err3 != nil { return fmt.Errorf("unable to decode dialogProjectionList#0x4e60f01f: field projections: %w", err3) }
...
if err != nil { return fmt.Errorf("unable to decode dialogProjectionList#0x4e60f01f: field next_top_message_date: %w", err) }
              m.NextTopPeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjectionList#0x4e60f01f: field next_top_peer_seq: %w", err) }
              m.NextPeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjectionList#0x4e60f01f: field next_peer_type: %w", err) }
              m.NextPeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjectionList#0x4e60f01f: field next_peer_id: %w", err) }
              
    m.Exhausted, err = tg.DecodeBoolClazz(d)
    if err != nil { return fmt.Errorf("unable to decode dialogProjectionList#0x4e60f01f: field exhausted: %w", err) }
...
func (m *TLDialogProjectionPeer) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x6d7ec124:
              m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode dialogProjectionPeer#0x6d7ec124: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode dialogProjectionPeer#0x6d7ec124: field peer_id: %w", err) }
...
func (m *TLMessageViewList) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_messageViewList, int(layer)); clazzId {
        case 0x3127345e:
                  if err := iface.ValidateRequiredSlice("messages", m.Messages); err != nil { return err }
...
func (m *TLMessageViewList) Encode(x *bin.Encoder, layer int32) error {
    ...
    if err := iface.EncodeObjectList(x, m.Messages, layer); err != nil { return fmt.Errorf("unable to encode messageViewList#0x3127345e: field messages: %w", err) }
...
func (m *TLMessageViewList) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x3127345e:
                 l0, err3 := d.VectorHeader()
    if err3 != nil { return fmt.Errorf("unable to decode messageViewList#0x3127345e: field messages: %w", err3) }
    if l0 > bin.MaxVectorLen {
...
func (m *TLMessageViewPeerSeq) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x8bf3b9a4:
              m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode messageViewPeerSeq#0x8bf3b9a4: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode messageViewPeerSeq#0x8bf3b9a4: field peer_id: %w", err) }
              m.PeerSeq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode messageViewPeerSeq#0x8bf3b9a4: field peer_seq: %w", err) }
...
func (m *TLUserAuthSeqAppendResult) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_userAuthSeqAppendResult, int(layer)); clazzId {
        case 0x55994646:
              if err := iface.ValidateRequiredString("operation_id", m.OperationId); err != nil { return err }


              if err := iface.ValidateRequiredObject("already_applied", m.AlreadyApplied); err != nil { return err }
    ...
    switch clazzId := iface.GetClazzIDByName(ClazzName_userAuthSeqAppendResult, int(layer)); clazzId {
        case 0x55994646:
            x.PutClazzID(0x55994646)
               ...
               x.PutInt64(m.Seq)
               x.PutInt32(m.Date)
              if m.AlreadyApplied == nil { return fmt.Errorf("unable to encode userAuthSeqAppendResult#0x55994646: field already_applied is nil") }
if err := m.AlreadyApplied.Encode(x, layer); err != nil { return fmt.Errorf("unable to encode userAuthSeqAppendResult#0x55994646: field already_applied: %w", err) }
...
if err != nil { return fmt.Errorf("unable to decode userAuthSeqAppendResult#0x55994646: field user_id: %w", err) }
              m.OperationId, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userAuthSeqAppendResult#0x55994646: field operation_id: %w", err) }
              m.Seq, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userAuthSeqAppendResult#0x55994646: field seq: %w", err) }
              m.Date, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userAuthSeqAppendResult#0x55994646: field date: %w", err) }
              
    m.AlreadyApplied, err = tg.DecodeBoolClazz(d)
    if err != nil { return fmt.Errorf("unable to decode userAuthSeqAppendResult#0x55994646: field already_applied: %w", err) }
...
func (m *TLUserDifferenceEmpty) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_userDifferenceEmpty, int(layer)); clazzId {
        case 0xb38ac177:
              if err := iface.ValidateRequiredObject("state", m.State); err != nil { return err }
    ...
    switch clazzId := iface.GetClazzIDByName(ClazzName_userDifferenceEmpty, int(layer)); clazzId {
        case 0xb38ac177:
            x.PutClazzID(0xb38ac177)
			  ...
			  if m.State == nil { return fmt.Errorf("unable to encode userDifferenceEmpty#0xb38ac177: field state is nil") }
if err := m.State.Encode(x, layer); err != nil { return fmt.Errorf("unable to encode userDifferenceEmpty#0xb38ac177: field state: %w", err) }
...
func (m *TLUserDifferenceEmpty) Decode(d *bin.Decoder) (err error) {
    ...
    if err != nil { return fmt.Errorf("unable to decode userDifferenceEmpty#0xb38ac177: field state: %w", err) }
...
func (m *TLUserDifference) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_userDifference, int(layer)); clazzId {
        case 0xb15cb08d:
                  if err := iface.ValidateRequiredSlice("new_messages", m.NewMessages); err != nil { return err }

                  if err := iface.ValidateRequiredSlice("other_updates", m.OtherUpdates); err != nil { return err }
...
func (m *TLUserDifference) Encode(x *bin.Encoder, layer int32) error {
    ...
    if err := iface.EncodeObjectList(x, m.NewMessages, layer); err != nil { return fmt.Errorf("unable to encode userDifference#0xb15cb08d: field new_messages: %w", err) }

              
    if err := iface.EncodeObjectList(x, m.OtherUpdates, layer); err != nil { return fmt.Errorf("unable to encode userDifference#0xb15cb08d: field other_updates: %w", err) }

              if m.State == nil { return fmt.Errorf("unable to encode userDifference#0xb15cb08d: field state is nil") }
if err := m.State.Encode(x, layer); err != nil { return fmt.Errorf("unable to encode userDifference#0xb15cb08d: field state: %w", err) }
...
func (m *TLUserDifference) Decode(d *bin.Decoder) (err error) {
    ...
    if err3 != nil { return fmt.Errorf("unable to decode userDifference#0xb15cb08d: field new_messages: %w", err3) }
    ...
    if err3 != nil { return fmt.Errorf("unable to decode userDifference#0xb15cb08d: field other_updates: %w", err3) }
    ...
    m.State, err = DecodeUserStateClazz(d)
    if err != nil { return fmt.Errorf("unable to decode userDifference#0xb15cb08d: field state: %w", err) }
...
func (m *TLUserDifferenceSlice) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_userDifferenceSlice, int(layer)); clazzId {
        case 0x4ef1987f:
              ...
              if err := iface.ValidateRequiredObject("intermediate_state", m.IntermediateState); err != nil { return err }
...
func (m *TLUserDifferenceSlice) Encode(x *bin.Encoder, layer int32) error {
    ...
    if err := iface.EncodeObjectList(x, m.NewMessages, layer); err != nil { return fmt.Errorf("unable to encode userDifferenceSlice#0x4ef1987f: field new_messages: %w", err) }

              
    if err := iface.EncodeObjectList(x, m.OtherUpdates, layer); err != nil { return fmt.Errorf("unable to encode userDifferenceSlice#0x4ef1987f: field other_updates: %w", err) }

              if m.IntermediateState == nil { return fmt.Errorf("unable to encode userDifferenceSlice#0x4ef1987f: field intermediate_state is nil") }
if err := m.IntermediateState.Encode(x, layer); err != nil { return fmt.Errorf("unable to encode userDifferenceSlice#0x4ef1987f: field intermediate_state: %w", err) }
...
func (m *TLUserDifferenceSlice) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x4ef1987f:
                 l1, err3 := d.VectorHeader()
    if err3 != nil { return fmt.Errorf("unable to decode userDifferenceSlice#0x4ef1987f: field new_messages: %w", err3) }
    if l1 > bin.MaxVectorLen {
    ...
    m.NewMessages = v1
                 ...
                 l2, err3 := d.VectorHeader()
    if err3 != nil { return fmt.Errorf("unable to decode userDifferenceSlice#0x4ef1987f: field other_updates: %w", err3) }
    if l2 > bin.MaxVectorLen {
    ...
    if err != nil { return fmt.Errorf("unable to decode userDifferenceSlice#0x4ef1987f: field intermediate_state: %w", err) }
...
func (m *TLUserDifferenceTooLong) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x1d095703:
              m.Pts, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userDifferenceTooLong#0x1d095703: field pts: %w", err) }
    ...
    switch clazzId := iface.GetClazzIDByName(ClazzName_userOperation, int(layer)); clazzId {
        case 0x2d4e84d7:
            ...
            size += 4
              ...
              size += 4
              size += 8
              if m.AuthKeyId != nil { size += 8 }

              if m.AuthKeyIdExclude != nil { size += 8 }

              size += 4
              size += 8
              if m.CanonicalMessageId != nil { size += 8 }

              if m.CanonicalPeerSeq != nil { size += 8 }

              if m.CanonicalDate != nil { size += 8 }

              if m.DependencyPts != nil { size += 8 }

              if m.RequestId != nil { size += iface.CalcStringSize(*m.RequestId) }
...
func (m *TLUserOperation) Validate(layer int32) error {
    switch clazzId := iface.GetClazzIDByName(ClazzName_userOperation, int(layer)); clazzId {
        case 0x2d4e84d7:
              ...
              if err := iface.ValidateRequiredBytes("payload_hash", m.PayloadHash); err != nil { return err }

              if err := iface.ValidateRequiredBytes("payload", m.Payload); err != nil { return err }
        ...
        case 0x2d4e84d7:
            ...
            var getFlags = func() uint32 {
			 ...
			 // set flags
              ...
              if m.AuthKeyId != nil { x.PutInt64(*m.AuthKeyId) }

              if m.AuthKeyIdExclude != nil { x.PutInt64(*m.AuthKeyIdExclude) }

               x.PutInt32(m.PeerType)
               x.PutInt64(m.PeerId)
              if m.CanonicalMessageId != nil { x.PutInt64(*m.CanonicalMessageId) }

              if m.CanonicalPeerSeq != nil { x.PutInt64(*m.CanonicalPeerSeq) }

              if m.CanonicalDate != nil { x.PutInt64(*m.CanonicalDate) }

              if m.DependencyPts != nil { x.PutInt64(*m.DependencyPts) }

              if m.RequestId != nil { x.PutString(*m.RequestId) }
...
func (m *TLUserOperation) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x2d4e84d7:
             flags, err := d.Uint32()
            if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field flags: %w", err) }
            _ = flags
			  m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field user_id: %w", err) }
              m.BucketId, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field bucket_id: %w", err) }
              m.PartitionId, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field partition_id: %w", err) }
              m.OperationId, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field operation_id: %w", err) }
              m.OpType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field op_type: %w", err) }
              m.OpSource, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field op_source: %w", err) }
              m.ActorUserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field actor_user_id: %w", err) }
              if (flags & (1 << 0)) != 0 { m.AuthKeyId = new(int64); *m.AuthKeyId, err = d.Int64(); if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field auth_key_id: %w", err) } }

              if (flags & (1 << 1)) != 0 { m.AuthKeyIdExclude = new(int64); *m.AuthKeyIdExclude, err = d.Int64(); if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field auth_key_id_exclude: %w", err) } }

              m.PeerType, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field peer_type: %w", err) }
              m.PeerId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field peer_id: %w", err) }
              if (flags & (1 << 2)) != 0 { m.CanonicalMessageId = new(int64); *m.CanonicalMessageId, err = d.Int64(); if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field canonical_message_id: %w", err) } }

              if (flags & (1 << 3)) != 0 { m.CanonicalPeerSeq = new(int64); *m.CanonicalPeerSeq, err = d.Int64(); if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field canonical_peer_seq: %w", err) } }

              if (flags & (1 << 4)) != 0 { m.CanonicalDate = new(int64); *m.CanonicalDate, err = d.Int64(); if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field canonical_date: %w", err) } }

              if (flags & (1 << 5)) != 0 { m.DependencyPts = new(int64); *m.DependencyPts, err = d.Int64(); if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field dependency_pts: %w", err) } }

              if (flags & (1 << 6)) != 0 { m.RequestId = new(string);  *m.RequestId, err = d.String(); if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field request_id: %w", err) } }

              m.PayloadSchemaVersion, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field payload_schema_version: %w", err) }
              m.PayloadCodec, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field payload_codec: %w", err) }
              m.PayloadHash, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field payload_hash: %w", err) } 
              m.Payload, err = d.Bytes()
if err != nil { return fmt.Errorf("unable to decode userOperation#0x2d4e84d7: field payload: %w", err) } 
    ...
    switch clazzId := iface.GetClazzIDByName(ClazzName_userOperationResult, int(layer)); clazzId {
        case 0x7311db72:
            ...
            size += 4
              ...
              size += 4
              size += 8
              if m.ResponseSchemaVersion != nil { size += 4 }

              if m.ResponsePayload != nil { size += iface.CalcBytesSize(m.ResponsePayload) }

              if m.ResponsePayloadHash != nil { size += iface.CalcBytesSize(m.ResponsePayloadHash) }
        ...
        case 0x7311db72:
            ...
            var getFlags = func() uint32 {
			 ...
			 // set flags
              ...
              if m.ResponseSchemaVersion != nil { x.PutInt32(*m.ResponseSchemaVersion) }

              if m.ResponsePayload != nil { x.PutBytes(m.ResponsePayload) }

              if m.ResponsePayloadHash != nil { x.PutBytes(m.ResponsePayloadHash) }
...
func (m *TLUserOperationResult) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x7311db72:
             flags, err := d.Uint32()
            if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field flags: %w", err) }
            _ = flags
			  m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field user_id: %w", err) }
              m.OperationId, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field operation_id: %w", err) }
              m.Status, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field status: %w", err) }
              m.Pts, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field pts: %w", err) }
              m.PtsCount, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field pts_count: %w", err) }
              m.CurrentPts, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field current_pts: %w", err) }
              if (flags & (1 << 0)) != 0 {
    m.ResponseSchemaVersion = new(int32)
    *m.ResponseSchemaVersion, err = d.Int32()
    if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field response_schema_version: %w", err) }
}
              if (flags & (1 << 1)) != 0 { m.ResponsePayload, err = d.Bytes(); if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field response_payload: %w", err) } }

              if (flags & (1 << 2)) != 0 { m.ResponsePayloadHash, err = d.Bytes(); if err != nil { return fmt.Errorf("unable to decode userOperationResult#0x7311db72: field response_payload_hash: %w", err) } }
    ...
    switch clazzId := iface.GetClazzIDByName(ClazzName_userPtsAppendResult, int(layer)); clazzId {
        case 0xaa3fff4f:
            x.PutClazzID(0xaa3fff4f)
               ...
               x.PutInt64(m.Pts)
               x.PutInt32(m.PtsCount)
              if m.AlreadyApplied == nil { return fmt.Errorf("unable to encode userPtsAppendResult#0xaa3fff4f: field already_applied is nil") }
if err := m.AlreadyApplied.Encode(x, layer); err != nil { return fmt.Errorf("unable to encode userPtsAppendResult#0xaa3fff4f: field already_applied: %w", err) }
...
func (m *TLUserPtsAppendResult) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0xaa3fff4f:
              m.UserId, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userPtsAppendResult#0xaa3fff4f: field user_id: %w", err) }
              m.OperationId, err = d.String()
if err != nil { return fmt.Errorf("unable to decode userPtsAppendResult#0xaa3fff4f: field operation_id: %w", err) }
              m.Pts, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userPtsAppendResult#0xaa3fff4f: field pts: %w", err) }
              m.PtsCount, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userPtsAppendResult#0xaa3fff4f: field pts_count: %w", err) }
              
    m.AlreadyApplied, err = tg.DecodeBoolClazz(d)
    if err != nil { return fmt.Errorf("unable to decode userPtsAppendResult#0xaa3fff4f: field already_applied: %w", err) }
...
func (m *TLUserState) Decode(d *bin.Decoder) (err error) {
    switch m.ClazzID {
        case 0x635f3815:
              m.Pts, err = d.Int64()
if err != nil { return fmt.Errorf("unable to decode userState#0x635f3815: field pts: %w", err) }
              m.Qts, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userState#0x635f3815: field qts: %w", err) }
              m.Date, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userState#0x635f3815: field date: %w", err) }
              m.Seq, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userState#0x635f3815: field seq: %w", err) }
              m.UnreadCount, err = d.Int32()
if err != nil { return fmt.Errorf("unable to decode userState#0x635f3815: field unread_count: %w", err) }
