...
func TestViewMessageDocumentMediaInfersLegacyFlagsFromAttributes(t *testing.T) {
...
func TestViewMessageDocumentMediaDoesNotInferVideoForWebMStickerOrCustomEmoji(t *testing.T) {
