...
func dialogProjectionToTL(in repository.DialogProjection) userupdates.DialogProjectionClazz {
	return userupdates.MakeTLDialogProjection(&userupdates.TLDialogProjection{
		...
		PeerId:                     in.PeerID,
		TopPeerSeq:                 in.TopPeerSeq,
		TopUserMessageId:           in.TopUserMessageID,
		...
		ReadInboxMaxUserMessageId:  in.ReadInboxMaxUserMessageID,
		ReadOutboxMaxPeerSeq:       in.ReadOutboxMaxPeerSeq,
		ReadOutboxMaxUserMessageId: in.ReadOutboxMaxUserMessageID,
		...
		PinnedUserMessageId:        in.PinnedUserMessageID,
		...
		AvailableMinUserMessageId:  in.AvailableMinUserMessageID,
		LastPts:                    in.LastPTS,
