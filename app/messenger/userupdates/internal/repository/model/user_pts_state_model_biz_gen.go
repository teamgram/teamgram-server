...
type bizUserPtsStateModel interface {
	...
	UpdatePts(ctx context.Context, pts int64, ptsUpdatedAt int64, partitionId int32, ownerEpoch int64, userId int64) (rowsAffected int64, err error)
}
...
type UserPtsStateTxModel interface {
	...
	UpdatePts(pts int64, ptsUpdatedAt int64, partitionId int32, ownerEpoch int64, userId int64) (rowsAffected int64, err error)
}
...
func (m *defaultUserPtsStateModel) UpdatePts(ctx context.Context, pts int64, ptsUpdatedAt int64, partitionId int32, ownerEpoch int64, userId int64) (rowsAffected int64, err error) {
...
// UpdatePts
// update user_pts_state set pts = :pts, pts_updated_at = :pts_updated_at, partition_id = :partition_id, owner_epoch = :owner_epoch, row_version = row_version + 1 where user_id = :user_id
func (m *defaultUserPtsStateTxModel) UpdatePts(pts int64, ptsUpdatedAt int64, partitionId int32, ownerEpoch int64, userId int64) (rowsAffected int64, err error) {
	var (
		query   = "update user_pts_state set pts = ?, pts_updated_at = ?, partition_id = ?, owner_epoch = ?, row_version = row_version + 1 where user_id = ?"
		rResult sql.Result
	)
