...
func init() {
	...
	iface.RegisterClazzName(ClazzName_sync_pushUpdatesIfNot, 0, 0x40053fe4) // 40053fe4
	...
	iface.RegisterClazzIDName(ClazzName_sync_pushUpdatesIfNot, 0x40053fe4) // 40053fe4
