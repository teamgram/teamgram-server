...
func (s *Service) MsgSendMessage(ctx context.Context, request *msg.TLMsgSendMessage) (*mtproto.Updates, error) {
	...
	c.Logger.Debugf("msg.sendMessage - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.sendMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgSendMultiMessage(ctx context.Context, request *msg.TLMsgSendMultiMessage) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.sendMultiMessage - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.sendMultiMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgPushUserMessage(ctx context.Context, request *msg.TLMsgPushUserMessage) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.pushUserMessage - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.pushUserMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgReadMessageContents(ctx context.Context, request *msg.TLMsgReadMessageContents) (*mtproto.Messages_AffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.readMessageContents - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.readMessageContents - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgSendMessageV2(ctx context.Context, request *msg.TLMsgSendMessageV2) (*mtproto.UpdateList, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.sendMessageV2 - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.sendMessageV2 - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgEditMessage(ctx context.Context, request *msg.TLMsgEditMessage) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.editMessage - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.editMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgDeleteMessages(ctx context.Context, request *msg.TLMsgDeleteMessages) (*mtproto.Messages_AffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.deleteMessages - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.deleteMessages - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgDeleteHistory(ctx context.Context, request *msg.TLMsgDeleteHistory) (*mtproto.Messages_AffectedHistory, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.deleteHistory - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.deleteHistory - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgDeletePhoneCallHistory(ctx context.Context, request *msg.TLMsgDeletePhoneCallHistory) (*mtproto.Messages_AffectedFoundMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.deletePhoneCallHistory - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.deletePhoneCallHistory - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgDeleteChatHistory(ctx context.Context, request *msg.TLMsgDeleteChatHistory) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.deleteChatHistory - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.deleteChatHistory - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgReadHistory(ctx context.Context, request *msg.TLMsgReadHistory) (*mtproto.Messages_AffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.readHistory - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.readHistory - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgUpdatePinnedMessage(ctx context.Context, request *msg.TLMsgUpdatePinnedMessage) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.updatePinnedMessage - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.updatePinnedMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MsgUnpinAllMessages(ctx context.Context, request *msg.TLMsgUnpinAllMessages) (*mtproto.Messages_AffectedHistory, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("msg.unpinAllMessages - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("msg.unpinAllMessages - reply: %s", r.DebugString())
	return r, err
}
