...
var rpcContextRegisters = map[string]RPCContextTuple{
	...
	"TLMsgDeleteChannelHistory":     RPCContextTuple{"/mtproto.RPCMsg/msg_deleteChannelHistory", func() interface{} { return new(mtproto.Messages_AffectedHistory) }},
	"TLMsgDeleteChannelUserHistory": RPCContextTuple{"/mtproto.RPCMsg/msg_deleteChannelUserHistory", func() interface{} { return new(mtproto.Messages_AffectedHistory) }},
	...
	"TLMsgReadChannelHistory":       RPCContextTuple{"/mtproto.RPCMsg/msg_readChannelHistory", func() interface{} { return new(mtproto.Bool) }},
