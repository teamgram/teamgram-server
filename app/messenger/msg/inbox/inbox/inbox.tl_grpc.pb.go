...
const (
	...
	RPCInbox_InboxUpdatePinnedMessageV2_FullMethodName      = "/inbox.RPCInbox/inbox_updatePinnedMessageV2"
)
...
type RPCInboxClient interface {
	...
	InboxUpdatePinnedMessageV2(ctx context.Context, in *TLInboxUpdatePinnedMessageV2, opts ...grpc.CallOption) (*mtproto.Void, error)
}
...
func (c *rPCInboxClient) InboxUpdatePinnedMessageV2(ctx context.Context, in *TLInboxUpdatePinnedMessageV2, opts ...grpc.CallOption) (*mtproto.Void, error) {
	out := new(mtproto.Void)
	err := c.cc.Invoke(ctx, RPCInbox_InboxUpdatePinnedMessageV2_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RPCInboxServer interface {
	...
	InboxUpdatePinnedMessageV2(context.Context, *TLInboxUpdatePinnedMessageV2) (*mtproto.Void, error)
}
...
func (UnimplementedRPCInboxServer) InboxUpdatePinnedMessageV2(context.Context, *TLInboxUpdatePinnedMessageV2) (*mtproto.Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InboxUpdatePinnedMessageV2 not implemented")
}
...
func _RPCInbox_InboxUpdatePinnedMessageV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TLInboxUpdatePinnedMessageV2)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RPCInboxServer).InboxUpdatePinnedMessageV2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RPCInbox_InboxUpdatePinnedMessageV2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RPCInboxServer).InboxUpdatePinnedMessageV2(ctx, req.(*TLInboxUpdatePinnedMessageV2))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RPCInbox_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "inbox_updatePinnedMessageV2",
			Handler:    _RPCInbox_InboxUpdatePinnedMessageV2_Handler,
		},
	},
