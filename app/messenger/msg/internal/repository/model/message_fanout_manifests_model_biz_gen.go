...
type bizMessageFanoutManifestsModel interface {
	...
	MarkCompleted(ctx context.Context, status int32, completedAt int64, manifestId int64) (rowsAffected int64, err error)
}
...
type MessageFanoutManifestsTxModel interface {
	...
	MarkCompleted(status int32, completedAt int64, manifestId int64) (rowsAffected int64, err error)
}
...
func (m *defaultMessageFanoutManifestsModel) MarkCompleted(ctx context.Context, status int32, completedAt int64, manifestId int64) (rowsAffected int64, err error) {
...
// MarkCompleted
// update message_fanout_manifests set `status` = :status, completed_at = :completed_at where manifest_id = :manifest_id
func (m *defaultMessageFanoutManifestsTxModel) MarkCompleted(status int32, completedAt int64, manifestId int64) (rowsAffected int64, err error) {
	var (
		query   = "update message_fanout_manifests set `status` = ?, completed_at = ? where manifest_id = ?"
		rResult sql.Result
	)
