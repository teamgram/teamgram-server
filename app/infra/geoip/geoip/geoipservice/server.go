...
func NewServer(handler geoip.RPCGeoip, opts ...server.Option) server.Server {
...
func RegisterService(svr server.Server, handler geoip.RPCGeoip, opts ...server.RegisterOption) error {
