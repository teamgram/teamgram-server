...
func (c *SavedMessageDialogsCore) MessagesGetPinnedSavedDialogs(in *tg.TLMessagesGetPinnedSavedDialogs) (*tg.MessagesSavedDialogs, error) {
	// TODO: not impl
	// c.Logger.Errorf("messages.getPinnedSavedDialogs blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("messages.getPinnedSavedDialogs not implemented")
}
