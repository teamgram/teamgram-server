...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"/tg.RPCUserChannelProfiles/account.updateStatus": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/account.updateBirthday": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/account.updatePersonalChannel": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/account.setMainProfileTab": kitex.NewMethodInfo(
		accountSetMainProfileTabHandler,
		newAccountSetMainProfileTabArgs,
		newAccountSetMainProfileTabResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"/tg.RPCUserChannelProfiles/account.saveMusic": kitex.NewMethodInfo(
		accountSaveMusicHandler,
		newAccountSaveMusicArgs,
		newAccountSaveMusicResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"/tg.RPCUserChannelProfiles/account.getSavedMusicIds": kitex.NewMethodInfo(
		accountGetSavedMusicIdsHandler,
		newAccountGetSavedMusicIdsArgs,
		newAccountGetSavedMusicIdsResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"/tg.RPCUserChannelProfiles/users.getSavedMusic": kitex.NewMethodInfo(
		usersGetSavedMusicHandler,
		newUsersGetSavedMusicArgs,
		newUsersGetSavedMusicResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"/tg.RPCUserChannelProfiles/users.getSavedMusicByID": kitex.NewMethodInfo(
		usersGetSavedMusicByIDHandler,
		newUsersGetSavedMusicByIDArgs,
		newUsersGetSavedMusicByIDResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"/tg.RPCUserChannelProfiles/users.suggestBirthday": kitex.NewMethodInfo(
		usersSuggestBirthdayHandler,
		newUsersSuggestBirthdayArgs,
		newUsersSuggestBirthdayResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"/tg.RPCUserChannelProfiles/contacts.getBirthdays": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/photos.updateProfilePhoto": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/photos.uploadProfilePhoto": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/photos.deletePhotos": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/photos.getUserPhotos": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/photos.uploadContactProfilePhoto": kitex.NewMethodInfo(
	...
	"/tg.RPCUserChannelProfiles/channels.setMainProfileTab": kitex.NewMethodInfo(
		channelsSetMainProfileTabHandler,
		newChannelsSetMainProfileTabArgs,
		newChannelsSetMainProfileTabResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"/tg.RPCUserChannelProfiles/account.updateVerified": kitex.NewMethodInfo(
...
var (
	userchannelprofilesServiceServiceInfo                = NewServiceInfo()
	userchannelprofilesServiceServiceInfoForClient       = NewServiceInfoForClient()
	userchannelprofilesServiceServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

func init() {
	iface.RegisterKitexServiceInfo("RPCUserChannelProfiles", userchannelprofilesServiceServiceInfo)
	iface.RegisterKitexServiceInfoForClient("RPCUserChannelProfiles", userchannelprofilesServiceServiceInfoForClient)
	iface.RegisterKitexServiceInfoForStreamClient("RPCUserChannelProfiles", userchannelprofilesServiceServiceInfoForStreamClient)
}

// for server
func serviceInfo() *kitex.ServiceInfo {
	return userchannelprofilesServiceServiceInfo
}

// for stream client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return userchannelprofilesServiceServiceInfoForStreamClient
}

// for client
func serviceInfoForClient() *kitex.ServiceInfo {
	return userchannelprofilesServiceServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	serviceName := "RPCUserChannelProfiles"
	handlerType := (*tg.RPCUserChannelProfiles)(nil)
	...
	extra := map[string]interface{}{
		"PackageName": "userchannelprofiles",
	}
	if hasStreaming {
...
func accountUpdateProfileHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).AccountUpdateProfile(ctx, realArg.Req)
	if err != nil {
		return err
	}
...
func accountUpdateStatusHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).AccountUpdateStatus(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func accountUpdateBirthdayHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).AccountUpdateBirthday(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func accountUpdatePersonalChannelHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).AccountUpdatePersonalChannel(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func accountSetMainProfileTabHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*AccountSetMainProfileTabArgs)
	realResult := result.(*AccountSetMainProfileTabResult)
	success, err := handler.(tg.RPCUserChannelProfiles).AccountSetMainProfileTab(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newAccountSetMainProfileTabArgs() interface{} {
	return &AccountSetMainProfileTabArgs{}
}

func newAccountSetMainProfileTabResult() interface{} {
	return &AccountSetMainProfileTabResult{}
}

type AccountSetMainProfileTabArgs struct {
	Req *tg.TLAccountSetMainProfileTab
}
...
func (p *AccountSetMainProfileTabArgs) Unmarshal(in []byte) error {
...
var AccountSetMainProfileTabArgs_Req_DEFAULT *tg.TLAccountSetMainProfileTab

func (p *AccountSetMainProfileTabArgs) GetReq() *tg.TLAccountSetMainProfileTab {
	if !p.IsSetReq() {
		return AccountSetMainProfileTabArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *AccountSetMainProfileTabArgs) IsSetReq() bool {
	return p.Req != nil
}

type AccountSetMainProfileTabResult struct {
	Success *tg.Bool
}

var AccountSetMainProfileTabResult_Success_DEFAULT *tg.Bool
...
func (p *AccountSetMainProfileTabResult) Unmarshal(in []byte) error {
	msg := new(tg.Bool)
	if err := json.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *AccountSetMainProfileTabResult) GetSuccess() *tg.Bool {
	if !p.IsSetSuccess() {
		return AccountSetMainProfileTabResult_Success_DEFAULT
	}
	return p.Success
}

func (p *AccountSetMainProfileTabResult) SetSuccess(x interface{}) {
	p.Success = x.(*tg.Bool)
}

func (p *AccountSetMainProfileTabResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *AccountSetMainProfileTabResult) GetResult() interface{} {
	return p.Success
}

func accountSaveMusicHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*AccountSaveMusicArgs)
	realResult := result.(*AccountSaveMusicResult)
	success, err := handler.(tg.RPCUserChannelProfiles).AccountSaveMusic(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newAccountSaveMusicArgs() interface{} {
	return &AccountSaveMusicArgs{}
}

func newAccountSaveMusicResult() interface{} {
	return &AccountSaveMusicResult{}
}

type AccountSaveMusicArgs struct {
	Req *tg.TLAccountSaveMusic
}
...
func (p *AccountSaveMusicArgs) Unmarshal(in []byte) error {
...
var AccountSaveMusicArgs_Req_DEFAULT *tg.TLAccountSaveMusic

func (p *AccountSaveMusicArgs) GetReq() *tg.TLAccountSaveMusic {
	if !p.IsSetReq() {
		return AccountSaveMusicArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *AccountSaveMusicArgs) IsSetReq() bool {
	return p.Req != nil
}

type AccountSaveMusicResult struct {
	Success *tg.Bool
}

var AccountSaveMusicResult_Success_DEFAULT *tg.Bool
...
func (p *AccountSaveMusicResult) Unmarshal(in []byte) error {
	msg := new(tg.Bool)
	if err := json.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *AccountSaveMusicResult) GetSuccess() *tg.Bool {
	if !p.IsSetSuccess() {
		return AccountSaveMusicResult_Success_DEFAULT
	}
	return p.Success
}

func (p *AccountSaveMusicResult) SetSuccess(x interface{}) {
	p.Success = x.(*tg.Bool)
}

func (p *AccountSaveMusicResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *AccountSaveMusicResult) GetResult() interface{} {
	return p.Success
}

func accountGetSavedMusicIdsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*AccountGetSavedMusicIdsArgs)
	realResult := result.(*AccountGetSavedMusicIdsResult)
	success, err := handler.(tg.RPCUserChannelProfiles).AccountGetSavedMusicIds(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newAccountGetSavedMusicIdsArgs() interface{} {
	return &AccountGetSavedMusicIdsArgs{}
}

func newAccountGetSavedMusicIdsResult() interface{} {
	return &AccountGetSavedMusicIdsResult{}
}

type AccountGetSavedMusicIdsArgs struct {
	Req *tg.TLAccountGetSavedMusicIds
}
...
func (p *AccountGetSavedMusicIdsArgs) Unmarshal(in []byte) error {
...
var AccountGetSavedMusicIdsArgs_Req_DEFAULT *tg.TLAccountGetSavedMusicIds

func (p *AccountGetSavedMusicIdsArgs) GetReq() *tg.TLAccountGetSavedMusicIds {
	if !p.IsSetReq() {
		return AccountGetSavedMusicIdsArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *AccountGetSavedMusicIdsArgs) IsSetReq() bool {
	return p.Req != nil
}

type AccountGetSavedMusicIdsResult struct {
	Success *tg.AccountSavedMusicIds
}

var AccountGetSavedMusicIdsResult_Success_DEFAULT *tg.AccountSavedMusicIds
...
func (p *AccountGetSavedMusicIdsResult) Unmarshal(in []byte) error {
...
func (p *AccountGetSavedMusicIdsResult) GetSuccess() *tg.AccountSavedMusicIds {
	if !p.IsSetSuccess() {
		return AccountGetSavedMusicIdsResult_Success_DEFAULT
	}
	return p.Success
}

func (p *AccountGetSavedMusicIdsResult) SetSuccess(x interface{}) {
	p.Success = x.(*tg.AccountSavedMusicIds)
}

func (p *AccountGetSavedMusicIdsResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *AccountGetSavedMusicIdsResult) GetResult() interface{} {
	return p.Success
}

func usersGetSavedMusicHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*UsersGetSavedMusicArgs)
	realResult := result.(*UsersGetSavedMusicResult)
	success, err := handler.(tg.RPCUserChannelProfiles).UsersGetSavedMusic(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newUsersGetSavedMusicArgs() interface{} {
	return &UsersGetSavedMusicArgs{}
}

func newUsersGetSavedMusicResult() interface{} {
	return &UsersGetSavedMusicResult{}
}

type UsersGetSavedMusicArgs struct {
	Req *tg.TLUsersGetSavedMusic
}
...
func (p *UsersGetSavedMusicArgs) Unmarshal(in []byte) error {
...
var UsersGetSavedMusicArgs_Req_DEFAULT *tg.TLUsersGetSavedMusic

func (p *UsersGetSavedMusicArgs) GetReq() *tg.TLUsersGetSavedMusic {
	if !p.IsSetReq() {
		return UsersGetSavedMusicArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *UsersGetSavedMusicArgs) IsSetReq() bool {
	return p.Req != nil
}

type UsersGetSavedMusicResult struct {
	Success *tg.UsersSavedMusic
}

var UsersGetSavedMusicResult_Success_DEFAULT *tg.UsersSavedMusic
...
func (p *UsersGetSavedMusicResult) Unmarshal(in []byte) error {
...
func (p *UsersGetSavedMusicResult) GetSuccess() *tg.UsersSavedMusic {
	if !p.IsSetSuccess() {
		return UsersGetSavedMusicResult_Success_DEFAULT
	}
	return p.Success
}

func (p *UsersGetSavedMusicResult) SetSuccess(x interface{}) {
	p.Success = x.(*tg.UsersSavedMusic)
}

func (p *UsersGetSavedMusicResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UsersGetSavedMusicResult) GetResult() interface{} {
	return p.Success
}

func usersGetSavedMusicByIDHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*UsersGetSavedMusicByIDArgs)
	realResult := result.(*UsersGetSavedMusicByIDResult)
	success, err := handler.(tg.RPCUserChannelProfiles).UsersGetSavedMusicByID(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newUsersGetSavedMusicByIDArgs() interface{} {
	return &UsersGetSavedMusicByIDArgs{}
}

func newUsersGetSavedMusicByIDResult() interface{} {
	return &UsersGetSavedMusicByIDResult{}
}

type UsersGetSavedMusicByIDArgs struct {
	Req *tg.TLUsersGetSavedMusicByID
}
...
func (p *UsersGetSavedMusicByIDArgs) Unmarshal(in []byte) error {
...
var UsersGetSavedMusicByIDArgs_Req_DEFAULT *tg.TLUsersGetSavedMusicByID

func (p *UsersGetSavedMusicByIDArgs) GetReq() *tg.TLUsersGetSavedMusicByID {
	if !p.IsSetReq() {
		return UsersGetSavedMusicByIDArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *UsersGetSavedMusicByIDArgs) IsSetReq() bool {
	return p.Req != nil
}

type UsersGetSavedMusicByIDResult struct {
	Success *tg.UsersSavedMusic
}

var UsersGetSavedMusicByIDResult_Success_DEFAULT *tg.UsersSavedMusic
...
func (p *UsersGetSavedMusicByIDResult) Unmarshal(in []byte) error {
	msg := new(tg.UsersSavedMusic)
	if err := json.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *UsersGetSavedMusicByIDResult) GetSuccess() *tg.UsersSavedMusic {
	if !p.IsSetSuccess() {
		return UsersGetSavedMusicByIDResult_Success_DEFAULT
	}
	return p.Success
}

func (p *UsersGetSavedMusicByIDResult) SetSuccess(x interface{}) {
	p.Success = x.(*tg.UsersSavedMusic)
}

func (p *UsersGetSavedMusicByIDResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UsersGetSavedMusicByIDResult) GetResult() interface{} {
	return p.Success
}

func usersSuggestBirthdayHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*UsersSuggestBirthdayArgs)
	realResult := result.(*UsersSuggestBirthdayResult)
	success, err := handler.(tg.RPCUserChannelProfiles).UsersSuggestBirthday(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newUsersSuggestBirthdayArgs() interface{} {
	return &UsersSuggestBirthdayArgs{}
}

func newUsersSuggestBirthdayResult() interface{} {
	return &UsersSuggestBirthdayResult{}
}

type UsersSuggestBirthdayArgs struct {
	Req *tg.TLUsersSuggestBirthday
}
...
func (p *UsersSuggestBirthdayArgs) Unmarshal(in []byte) error {
...
var UsersSuggestBirthdayArgs_Req_DEFAULT *tg.TLUsersSuggestBirthday

func (p *UsersSuggestBirthdayArgs) GetReq() *tg.TLUsersSuggestBirthday {
	if !p.IsSetReq() {
		return UsersSuggestBirthdayArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *UsersSuggestBirthdayArgs) IsSetReq() bool {
	return p.Req != nil
}

type UsersSuggestBirthdayResult struct {
	Success *tg.Updates
}

var UsersSuggestBirthdayResult_Success_DEFAULT *tg.Updates
...
func (p *UsersSuggestBirthdayResult) Unmarshal(in []byte) error {
	msg := new(tg.Updates)
	if err := json.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *UsersSuggestBirthdayResult) GetSuccess() *tg.Updates {
	if !p.IsSetSuccess() {
		return UsersSuggestBirthdayResult_Success_DEFAULT
	}
	return p.Success
}

func (p *UsersSuggestBirthdayResult) SetSuccess(x interface{}) {
	p.Success = x.(*tg.Updates)
}

func (p *UsersSuggestBirthdayResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UsersSuggestBirthdayResult) GetResult() interface{} {
	return p.Success
}
...
func contactsGetBirthdaysHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).ContactsGetBirthdays(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func photosUpdateProfilePhotoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).PhotosUpdateProfilePhoto(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func photosUploadProfilePhotoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).PhotosUploadProfilePhoto(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func photosDeletePhotosHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).PhotosDeletePhotos(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func photosGetUserPhotosHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).PhotosGetUserPhotos(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func photosUploadContactProfilePhotoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).PhotosUploadContactProfilePhoto(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func channelsSetMainProfileTabHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*ChannelsSetMainProfileTabArgs)
	realResult := result.(*ChannelsSetMainProfileTabResult)
	success, err := handler.(tg.RPCUserChannelProfiles).ChannelsSetMainProfileTab(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newChannelsSetMainProfileTabArgs() interface{} {
	return &ChannelsSetMainProfileTabArgs{}
}

func newChannelsSetMainProfileTabResult() interface{} {
	return &ChannelsSetMainProfileTabResult{}
}

type ChannelsSetMainProfileTabArgs struct {
	Req *tg.TLChannelsSetMainProfileTab
}
...
func (p *ChannelsSetMainProfileTabArgs) Unmarshal(in []byte) error {
...
var ChannelsSetMainProfileTabArgs_Req_DEFAULT *tg.TLChannelsSetMainProfileTab

func (p *ChannelsSetMainProfileTabArgs) GetReq() *tg.TLChannelsSetMainProfileTab {
	if !p.IsSetReq() {
		return ChannelsSetMainProfileTabArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *ChannelsSetMainProfileTabArgs) IsSetReq() bool {
	return p.Req != nil
}

type ChannelsSetMainProfileTabResult struct {
	Success *tg.Bool
}

var ChannelsSetMainProfileTabResult_Success_DEFAULT *tg.Bool
...
func (p *ChannelsSetMainProfileTabResult) Unmarshal(in []byte) error {
	msg := new(tg.Bool)
	if err := json.Unmarshal(in, msg); err != nil {
		return err
	}
...
func (p *ChannelsSetMainProfileTabResult) GetSuccess() *tg.Bool {
	if !p.IsSetSuccess() {
		return ChannelsSetMainProfileTabResult_Success_DEFAULT
	}
	return p.Success
}

func (p *ChannelsSetMainProfileTabResult) SetSuccess(x interface{}) {
	p.Success = x.(*tg.Bool)
}

func (p *ChannelsSetMainProfileTabResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ChannelsSetMainProfileTabResult) GetResult() interface{} {
	return p.Success
}
...
func accountUpdateVerifiedHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(tg.RPCUserChannelProfiles).AccountUpdateVerified(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
