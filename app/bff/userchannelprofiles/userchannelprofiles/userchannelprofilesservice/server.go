...
func NewServer(handler tg.RPCUserChannelProfiles, opts ...server.Option) server.Server {
...
func RegisterService(svr server.Server, handler tg.RPCUserChannelProfiles, opts ...server.RegisterOption) error {
