...
type UserChannelProfilesClient interface {
	...
	AccountSetMainProfileTab(ctx context.Context, in *tg.TLAccountSetMainProfileTab) (*tg.Bool, error)
	AccountSaveMusic(ctx context.Context, in *tg.TLAccountSaveMusic) (*tg.Bool, error)
	AccountGetSavedMusicIds(ctx context.Context, in *tg.TLAccountGetSavedMusicIds) (*tg.AccountSavedMusicIds, error)
	UsersGetSavedMusic(ctx context.Context, in *tg.TLUsersGetSavedMusic) (*tg.UsersSavedMusic, error)
	UsersGetSavedMusicByID(ctx context.Context, in *tg.TLUsersGetSavedMusicByID) (*tg.UsersSavedMusic, error)
	UsersSuggestBirthday(ctx context.Context, in *tg.TLUsersSuggestBirthday) (*tg.Updates, error)
