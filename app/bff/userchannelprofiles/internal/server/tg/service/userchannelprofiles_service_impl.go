...
import (
	...
	"github.com/teamgram/teamgram-server/v2/app/bff/userchannelprofiles/internal/core"
...
func (s *Service) AccountSetMainProfileTab(ctx context.Context, request *tg.TLAccountSetMainProfileTab) (*tg.Bool, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) AccountSaveMusic(ctx context.Context, request *tg.TLAccountSaveMusic) (*tg.Bool, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) AccountGetSavedMusicIds(ctx context.Context, request *tg.TLAccountGetSavedMusicIds) (*tg.AccountSavedMusicIds, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) UsersGetSavedMusic(ctx context.Context, request *tg.TLUsersGetSavedMusic) (*tg.UsersSavedMusic, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) UsersGetSavedMusicByID(ctx context.Context, request *tg.TLUsersGetSavedMusicByID) (*tg.UsersSavedMusic, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) UsersSuggestBirthday(ctx context.Context, request *tg.TLUsersSuggestBirthday) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) ChannelsSetMainProfileTab(ctx context.Context, request *tg.TLChannelsSetMainProfileTab) (*tg.Bool, error) {
	c := core.New(ctx, s.svcCtx)
