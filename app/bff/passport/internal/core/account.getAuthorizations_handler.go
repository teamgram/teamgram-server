...
func (c *PassportCore) AccountGetAuthorizations(in *tg.TLAccountGetAuthorizations) (*tg.AccountAuthorizations, error) {
	// TODO: not impl
	// c.Logger.Errorf("account.getAuthorizations blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("account.getAuthorizations not implemented")
}
