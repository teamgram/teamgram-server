...
func (c *PassportCore) UsersSetSecureValueErrors(in *tg.TLUsersSetSecureValueErrors) (*tg.Bool, error) {
	// TODO: not impl
	...
	return nil, errors.New("users.setSecureValueErrors not implemented")
}
