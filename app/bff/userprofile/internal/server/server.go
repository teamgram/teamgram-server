...
import (
	...
	"github.com/teamgooo/teamgooo-server/app/bff/userprofile/internal/config"
	"github.com/teamgooo/teamgooo-server/app/bff/userprofile/internal/server/tg/service"
	"github.com/teamgooo/teamgooo-server/app/bff/userprofile/internal/svc"
...
func (s *Server) Initialize() error {
	...
	s.kitexSrv = kitex.MustNewServer(
		...
		func(s server.Server) error {
			return userprofileservice.RegisterService(s, service.New(ctx))
		})
