...
func (c *UserProfileCore) AccountUpdatePersonalChannel(in *tg.TLAccountUpdatePersonalChannel) (*tg.Bool, error) {
	// TODO: not impl
	...
	return nil, errors.New("account.updatePersonalChannel not implemented")
}
