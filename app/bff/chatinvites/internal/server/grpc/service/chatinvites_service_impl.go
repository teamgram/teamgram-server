...
func (s *Service) MessagesExportChatInvite(ctx context.Context, request *mtproto.TLMessagesExportChatInvite) (*mtproto.ExportedChatInvite, error) {
	...
	c.Logger.Debugf("messages.exportChatInvite - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.exportChatInvite - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesCheckChatInvite(ctx context.Context, request *mtproto.TLMessagesCheckChatInvite) (*mtproto.ChatInvite, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.checkChatInvite - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.checkChatInvite - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesImportChatInvite(ctx context.Context, request *mtproto.TLMessagesImportChatInvite) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.importChatInvite - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.importChatInvite - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetExportedChatInvites(ctx context.Context, request *mtproto.TLMessagesGetExportedChatInvites) (*mtproto.Messages_ExportedChatInvites, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getExportedChatInvites - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getExportedChatInvites - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetExportedChatInvite(ctx context.Context, request *mtproto.TLMessagesGetExportedChatInvite) (*mtproto.Messages_ExportedChatInvite, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getExportedChatInvite - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getExportedChatInvite - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesEditExportedChatInvite(ctx context.Context, request *mtproto.TLMessagesEditExportedChatInvite) (*mtproto.Messages_ExportedChatInvite, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.editExportedChatInvite - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.editExportedChatInvite - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesDeleteRevokedExportedChatInvites(ctx context.Context, request *mtproto.TLMessagesDeleteRevokedExportedChatInvites) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.deleteRevokedExportedChatInvites - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.deleteRevokedExportedChatInvites - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesDeleteExportedChatInvite(ctx context.Context, request *mtproto.TLMessagesDeleteExportedChatInvite) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.deleteExportedChatInvite - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.deleteExportedChatInvite - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetAdminsWithInvites(ctx context.Context, request *mtproto.TLMessagesGetAdminsWithInvites) (*mtproto.Messages_ChatAdminsWithInvites, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getAdminsWithInvites - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getAdminsWithInvites - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetChatInviteImporters(ctx context.Context, request *mtproto.TLMessagesGetChatInviteImporters) (*mtproto.Messages_ChatInviteImporters, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getChatInviteImporters - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getChatInviteImporters - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesHideChatJoinRequest(ctx context.Context, request *mtproto.TLMessagesHideChatJoinRequest) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.hideChatJoinRequest - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.hideChatJoinRequest - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesHideAllChatJoinRequests(ctx context.Context, request *mtproto.TLMessagesHideAllChatJoinRequests) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.hideAllChatJoinRequests - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.hideAllChatJoinRequests - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) ChannelsToggleJoinToSend(ctx context.Context, request *mtproto.TLChannelsToggleJoinToSend) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("channels.toggleJoinToSend - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("channels.toggleJoinToSend - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) ChannelsToggleJoinRequest(ctx context.Context, request *mtproto.TLChannelsToggleJoinRequest) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("channels.toggleJoinRequest - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("channels.toggleJoinRequest - reply: %s", r.DebugString())
	return r, err
}
