...
func (c *ChatInvitesCore) MessagesHideChatJoinRequest(in *tg.TLMessagesHideChatJoinRequest) (*tg.Updates, error) {
	// TODO: not impl
	...
	return nil, errors.New("messages.hideChatJoinRequest not implemented")
}
