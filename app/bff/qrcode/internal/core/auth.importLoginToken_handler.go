...
func (c *QrCodeCore) AuthImportLoginToken(in *tg.TLAuthImportLoginToken) (*tg.AuthLoginToken, error) {
	// TODO: not impl
	// c.Logger.Errorf("auth.importLoginToken blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("auth.importLoginToken not implemented")
}
