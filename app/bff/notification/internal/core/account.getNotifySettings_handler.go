...
func (c *NotificationCore) AccountGetNotifySettings(in *tg.TLAccountGetNotifySettings) (*tg.PeerNotifySettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("account.getNotifySettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("account.getNotifySettings not implemented")
}
