...
func (c *NotificationCore) AccountGetNotifyExceptions(in *tg.TLAccountGetNotifyExceptions) (*tg.Updates, error) {
	// TODO: not impl
	// c.Logger.Errorf("account.getNotifyExceptions blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("account.getNotifyExceptions not implemented")
}
