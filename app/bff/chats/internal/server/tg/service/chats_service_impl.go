...
func (s *Service) MessagesEditChatCreator(ctx context.Context, request *tg.TLMessagesEditChatCreator) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) MessagesGetFutureChatCreatorAfterLeave(ctx context.Context, request *tg.TLMessagesGetFutureChatCreatorAfterLeave) (*tg.User, error) {
	c := core.New(ctx, s.svcCtx)
...
func (s *Service) MessagesEditChatParticipantRank(ctx context.Context, request *tg.TLMessagesEditChatParticipantRank) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
