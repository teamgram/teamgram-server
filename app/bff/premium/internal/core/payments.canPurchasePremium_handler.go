...
func (c *PremiumCore) PaymentsCanPurchasePremium(in *tg.TLPaymentsCanPurchasePremium) (*tg.Bool, error) {
	// TODO: not impl
	...
	return nil, errors.New("payments.canPurchasePremium not implemented")
}
