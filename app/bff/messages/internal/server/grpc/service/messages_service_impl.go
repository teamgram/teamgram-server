...
func (s *Service) MessagesGetAvailableEffects(ctx context.Context, request *mtproto.TLMessagesGetAvailableEffects) (*mtproto.Messages_AvailableEffects, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getAvailableEffects - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("messages.getAvailableEffects - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesEditFactCheck(ctx context.Context, request *mtproto.TLMessagesEditFactCheck) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.editFactCheck - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("messages.editFactCheck - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesDeleteFactCheck(ctx context.Context, request *mtproto.TLMessagesDeleteFactCheck) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.deleteFactCheck - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("messages.deleteFactCheck - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetFactCheck(ctx context.Context, request *mtproto.TLMessagesGetFactCheck) (*mtproto.Vector_FactCheck, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getFactCheck - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("messages.getFactCheck - reply: %s", r)
	return r, err
}
