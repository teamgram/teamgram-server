...
func (s *Service) MessagesGetMessages(ctx context.Context, request *mtproto.TLMessagesGetMessages) (*mtproto.Messages_Messages, error) {
	...
	c.Logger.Debugf("messages.getMessages - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getMessages - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetHistory(ctx context.Context, request *mtproto.TLMessagesGetHistory) (*mtproto.Messages_Messages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getHistory - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getHistory - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesSearch(ctx context.Context, request *mtproto.TLMessagesSearch) (*mtproto.Messages_Messages, error) {
	...
	c.Logger.Debugf("messages.search - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesReadHistory(ctx context.Context, request *mtproto.TLMessagesReadHistory) (*mtproto.Messages_AffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.readHistory - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.readHistory - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesDeleteHistory(ctx context.Context, request *mtproto.TLMessagesDeleteHistory) (*mtproto.Messages_AffectedHistory, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.deleteHistory - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.deleteHistory - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesDeleteMessages(ctx context.Context, request *mtproto.TLMessagesDeleteMessages) (*mtproto.Messages_AffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.deleteMessages - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.deleteMessages - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesReceivedMessages(ctx context.Context, request *mtproto.TLMessagesReceivedMessages) (*mtproto.Vector_ReceivedNotifyMessage, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.receivedMessages - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.receivedMessages - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesSendMessage(ctx context.Context, request *mtproto.TLMessagesSendMessage) (*mtproto.Updates, error) {
	...
	c.Logger.Debugf("messages.sendMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesSendMedia(ctx context.Context, request *mtproto.TLMessagesSendMedia) (*mtproto.Updates, error) {
	...
	c.Logger.Debugf("messages.sendMedia - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesForwardMessages(ctx context.Context, request *mtproto.TLMessagesForwardMessages) (*mtproto.Updates, error) {
	...
	c.Logger.Debugf("messages.forwardMessages - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesReadMessageContents(ctx context.Context, request *mtproto.TLMessagesReadMessageContents) (*mtproto.Messages_AffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.readMessageContents - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.readMessageContents - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetMessagesViews(ctx context.Context, request *mtproto.TLMessagesGetMessagesViews) (*mtproto.Messages_MessageViews, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getMessagesViews - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getMessagesViews - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesSearchGlobal(ctx context.Context, request *mtproto.TLMessagesSearchGlobal) (*mtproto.Messages_Messages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.searchGlobal - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.searchGlobal - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetMessageEditData(ctx context.Context, request *mtproto.TLMessagesGetMessageEditData) (*mtproto.Messages_MessageEditData, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getMessageEditData - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getMessageEditData - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesEditMessage(ctx context.Context, request *mtproto.TLMessagesEditMessage) (*mtproto.Updates, error) {
	...
	c.Logger.Debugf("messages.editMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetUnreadMentions(ctx context.Context, request *mtproto.TLMessagesGetUnreadMentions) (*mtproto.Messages_Messages, error) {
	...
	c.Logger.Debugf("messages.getUnreadMentions - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesReadMentions(ctx context.Context, request *mtproto.TLMessagesReadMentions) (*mtproto.Messages_AffectedHistory, error) {
	...
	c.Logger.Debugf("messages.readMentions - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetRecentLocations(ctx context.Context, request *mtproto.TLMessagesGetRecentLocations) (*mtproto.Messages_Messages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getRecentLocations - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.getRecentLocations - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesSendMultiMedia(ctx context.Context, request *mtproto.TLMessagesSendMultiMedia) (*mtproto.Updates, error) {
	...
	c.Logger.Debugf("messages.sendMultiMedia - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesUpdatePinnedMessage(ctx context.Context, request *mtproto.TLMessagesUpdatePinnedMessage) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.updatePinnedMessage - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.updatePinnedMessage - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetSearchCounters(ctx context.Context, request *mtproto.TLMessagesGetSearchCounters) (*mtproto.Vector_Messages_SearchCounter, error) {
	...
	c.Logger.Debugf("messages.getSearchCounters - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesUnpinAllMessages(ctx context.Context, request *mtproto.TLMessagesUnpinAllMessages) (*mtproto.Messages_AffectedHistory, error) {
	...
	c.Logger.Debugf("messages.unpinAllMessages - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetSearchResultsCalendar(ctx context.Context, request *mtproto.TLMessagesGetSearchResultsCalendar) (*mtproto.Messages_SearchResultsCalendar, error) {
	...
	c.Logger.Debugf("messages.getSearchResultsCalendar - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesGetSearchResultsPositions(ctx context.Context, request *mtproto.TLMessagesGetSearchResultsPositions) (*mtproto.Messages_SearchResultsPositions, error) {
	...
	c.Logger.Debugf("messages.getSearchResultsPositions - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesToggleNoForwards(ctx context.Context, request *mtproto.TLMessagesToggleNoForwards) (*mtproto.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.toggleNoForwards - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.toggleNoForwards - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesSaveDefaultSendAs(ctx context.Context, request *mtproto.TLMessagesSaveDefaultSendAs) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.saveDefaultSendAs - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("messages.saveDefaultSendAs - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MessagesSearchSentMedia(ctx context.Context, request *mtproto.TLMessagesSearchSentMedia) (*mtproto.Messages_Messages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.searchSentMedia - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
...
func (s *Service) MessagesGetAvailableEffects(ctx context.Context, request *mtproto.TLMessagesGetAvailableEffects) (*mtproto.Messages_AvailableEffects, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("messages.getAvailableEffects - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())

	r, err := c.MessagesGetAvailableEffects(request)
	if err != nil {
		return nil, err
	}

	c.Logger.Debugf("messages.getAvailableEffects - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) ChannelsGetSendAs(ctx context.Context, request *mtproto.TLChannelsGetSendAs) (*mtproto.Channels_SendAsPeers, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("channels.getSendAs - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("channels.getSendAs - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) ChannelsSearchPosts(ctx context.Context, request *mtproto.TLChannelsSearchPosts) (*mtproto.Messages_Messages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("channels.searchPosts - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
