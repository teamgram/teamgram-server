...
func (s *Service) MessagesGetMessages(ctx context.Context, request *tg.TLMessagesGetMessages) (*tg.MessagesMessages, error) {
	...
	c.Debugf("messages.getMessages - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetMessages(request)
	if err != nil {
		c.Errorf("messages.getMessages - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getMessages - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetHistory(ctx context.Context, request *tg.TLMessagesGetHistory) (*tg.MessagesMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getHistory - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetHistory(request)
	if err != nil {
		c.Errorf("messages.getHistory - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getHistory - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSearch(ctx context.Context, request *tg.TLMessagesSearch) (*tg.MessagesMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.search - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSearch(request)
	if err != nil {
		c.Errorf("messages.search - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.search - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesReadHistory(ctx context.Context, request *tg.TLMessagesReadHistory) (*tg.MessagesAffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.readHistory - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesReadHistory(request)
	if err != nil {
		c.Errorf("messages.readHistory - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.readHistory - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesDeleteHistory(ctx context.Context, request *tg.TLMessagesDeleteHistory) (*tg.MessagesAffectedHistory, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.deleteHistory - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesDeleteHistory(request)
	if err != nil {
		c.Errorf("messages.deleteHistory - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.deleteHistory - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesDeleteMessages(ctx context.Context, request *tg.TLMessagesDeleteMessages) (*tg.MessagesAffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.deleteMessages - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesDeleteMessages(request)
	if err != nil {
		c.Errorf("messages.deleteMessages - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.deleteMessages - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesReceivedMessages(ctx context.Context, request *tg.TLMessagesReceivedMessages) (*tg.VectorReceivedNotifyMessage, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.receivedMessages - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesReceivedMessages(request)
	if err != nil {
		c.Errorf("messages.receivedMessages - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.receivedMessages - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSendMessage(ctx context.Context, request *tg.TLMessagesSendMessage) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.sendMessage - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSendMessage(request)
	if err != nil {
		c.Errorf("messages.sendMessage - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.sendMessage - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSendMedia(ctx context.Context, request *tg.TLMessagesSendMedia) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.sendMedia - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSendMedia(request)
	if err != nil {
		c.Errorf("messages.sendMedia - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.sendMedia - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesForwardMessages(ctx context.Context, request *tg.TLMessagesForwardMessages) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.forwardMessages - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesForwardMessages(request)
	if err != nil {
		c.Errorf("messages.forwardMessages - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.forwardMessages - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesReadMessageContents(ctx context.Context, request *tg.TLMessagesReadMessageContents) (*tg.MessagesAffectedMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.readMessageContents - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesReadMessageContents(request)
	if err != nil {
		c.Errorf("messages.readMessageContents - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.readMessageContents - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetMessagesViews(ctx context.Context, request *tg.TLMessagesGetMessagesViews) (*tg.MessagesMessageViews, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getMessagesViews - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetMessagesViews(request)
	if err != nil {
		c.Errorf("messages.getMessagesViews - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getMessagesViews - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSearchGlobal(ctx context.Context, request *tg.TLMessagesSearchGlobal) (*tg.MessagesMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.searchGlobal - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSearchGlobal(request)
	if err != nil {
		c.Errorf("messages.searchGlobal - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.searchGlobal - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetMessageEditData(ctx context.Context, request *tg.TLMessagesGetMessageEditData) (*tg.MessagesMessageEditData, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getMessageEditData - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetMessageEditData(request)
	if err != nil {
		c.Errorf("messages.getMessageEditData - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getMessageEditData - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesEditMessage(ctx context.Context, request *tg.TLMessagesEditMessage) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.editMessage - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesEditMessage(request)
	if err != nil {
		c.Errorf("messages.editMessage - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.editMessage - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetUnreadMentions(ctx context.Context, request *tg.TLMessagesGetUnreadMentions) (*tg.MessagesMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getUnreadMentions - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetUnreadMentions(request)
	if err != nil {
		c.Errorf("messages.getUnreadMentions - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getUnreadMentions - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesReadMentions(ctx context.Context, request *tg.TLMessagesReadMentions) (*tg.MessagesAffectedHistory, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.readMentions - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesReadMentions(request)
	if err != nil {
		c.Errorf("messages.readMentions - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.readMentions - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetRecentLocations(ctx context.Context, request *tg.TLMessagesGetRecentLocations) (*tg.MessagesMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getRecentLocations - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetRecentLocations(request)
	if err != nil {
		c.Errorf("messages.getRecentLocations - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getRecentLocations - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSendMultiMedia(ctx context.Context, request *tg.TLMessagesSendMultiMedia) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.sendMultiMedia - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSendMultiMedia(request)
	if err != nil {
		c.Errorf("messages.sendMultiMedia - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.sendMultiMedia - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesUpdatePinnedMessage(ctx context.Context, request *tg.TLMessagesUpdatePinnedMessage) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.updatePinnedMessage - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesUpdatePinnedMessage(request)
	if err != nil {
		c.Errorf("messages.updatePinnedMessage - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.updatePinnedMessage - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetSearchCounters(ctx context.Context, request *tg.TLMessagesGetSearchCounters) (*tg.VectorMessagesSearchCounter, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getSearchCounters - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetSearchCounters(request)
	if err != nil {
		c.Errorf("messages.getSearchCounters - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getSearchCounters - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesUnpinAllMessages(ctx context.Context, request *tg.TLMessagesUnpinAllMessages) (*tg.MessagesAffectedHistory, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.unpinAllMessages - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesUnpinAllMessages(request)
	if err != nil {
		c.Errorf("messages.unpinAllMessages - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.unpinAllMessages - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetSearchResultsCalendar(ctx context.Context, request *tg.TLMessagesGetSearchResultsCalendar) (*tg.MessagesSearchResultsCalendar, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getSearchResultsCalendar - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetSearchResultsCalendar(request)
	if err != nil {
		c.Errorf("messages.getSearchResultsCalendar - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getSearchResultsCalendar - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetSearchResultsPositions(ctx context.Context, request *tg.TLMessagesGetSearchResultsPositions) (*tg.MessagesSearchResultsPositions, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getSearchResultsPositions - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetSearchResultsPositions(request)
	if err != nil {
		c.Errorf("messages.getSearchResultsPositions - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getSearchResultsPositions - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesToggleNoForwards(ctx context.Context, request *tg.TLMessagesToggleNoForwards) (*tg.Updates, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.toggleNoForwards - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesToggleNoForwards(request)
	if err != nil {
		c.Errorf("messages.toggleNoForwards - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.toggleNoForwards - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSaveDefaultSendAs(ctx context.Context, request *tg.TLMessagesSaveDefaultSendAs) (*tg.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.saveDefaultSendAs - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSaveDefaultSendAs(request)
	if err != nil {
		c.Errorf("messages.saveDefaultSendAs - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.saveDefaultSendAs - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSearchSentMedia(ctx context.Context, request *tg.TLMessagesSearchSentMedia) (*tg.MessagesMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.searchSentMedia - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSearchSentMedia(request)
	if err != nil {
		c.Errorf("messages.searchSentMedia - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.searchSentMedia - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesGetOutboxReadDate(ctx context.Context, request *tg.TLMessagesGetOutboxReadDate) (*tg.OutboxReadDate, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.getOutboxReadDate - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesGetOutboxReadDate(request)
	if err != nil {
		c.Errorf("messages.getOutboxReadDate - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.getOutboxReadDate - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesSummarizeText(ctx context.Context, request *tg.TLMessagesSummarizeText) (*tg.TextWithEntities, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.summarizeText - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesSummarizeText(request)
	if err != nil {
		c.Errorf("messages.summarizeText - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.summarizeText - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesComposeMessageWithAI(ctx context.Context, request *tg.TLMessagesComposeMessageWithAI) (*tg.MessagesComposedMessageWithAI, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.composeMessageWithAI - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesComposeMessageWithAI(request)
	if err != nil {
		c.Errorf("messages.composeMessageWithAI - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.composeMessageWithAI - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesReportReadMetrics(ctx context.Context, request *tg.TLMessagesReportReadMetrics) (*tg.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.reportReadMetrics - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesReportReadMetrics(request)
	if err != nil {
		c.Errorf("messages.reportReadMetrics - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.reportReadMetrics - reply: %s", r)
	return r, err
}
...
func (s *Service) MessagesReportMusicListen(ctx context.Context, request *tg.TLMessagesReportMusicListen) (*tg.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("messages.reportMusicListen - metadata: %s, request: %s", c.MD, request)

	r, err := c.MessagesReportMusicListen(request)
	if err != nil {
		c.Errorf("messages.reportMusicListen - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("messages.reportMusicListen - reply: %s", r)
	return r, err
}
...
func (s *Service) ChannelsGetSendAs(ctx context.Context, request *tg.TLChannelsGetSendAs) (*tg.ChannelsSendAsPeers, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("channels.getSendAs - metadata: %s, request: %s", c.MD, request)

	r, err := c.ChannelsGetSendAs(request)
	if err != nil {
		c.Errorf("channels.getSendAs - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("channels.getSendAs - reply: %s", r)
	return r, err
}
...
func (s *Service) ChannelsSearchPosts(ctx context.Context, request *tg.TLChannelsSearchPosts) (*tg.MessagesMessages, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("channels.searchPosts - metadata: %s, request: %s", c.MD, request)

	r, err := c.ChannelsSearchPosts(request)
	if err != nil {
		c.Errorf("channels.searchPosts - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("channels.searchPosts - reply: %s", r)
	return r, err
}
...
func (s *Service) ChannelsCheckSearchPostsFlood(ctx context.Context, request *tg.TLChannelsCheckSearchPostsFlood) (*tg.SearchPostsFlood, error) {
	c := core.New(ctx, s.svcCtx)
	c.Debugf("channels.checkSearchPostsFlood - metadata: %s, request: %s", c.MD, request)

	r, err := c.ChannelsCheckSearchPostsFlood(request)
	if err != nil {
		c.Errorf("channels.checkSearchPostsFlood - error: request: %s, err: %v", request, err)
		return nil, err
	}

	c.Debugf("channels.checkSearchPostsFlood - reply: %s", r)
	return r, err
}
