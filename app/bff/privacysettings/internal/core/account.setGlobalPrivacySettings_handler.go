...
func (c *PrivacySettingsCore) AccountSetGlobalPrivacySettings(in *tg.TLAccountSetGlobalPrivacySettings) (*tg.GlobalPrivacySettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("account.setGlobalPrivacySettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("account.setGlobalPrivacySettings not implemented")
}
