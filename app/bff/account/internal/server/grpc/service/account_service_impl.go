...
func (s *Service) AccountUpdateProfile(ctx context.Context, request *mtproto.TLAccountUpdateProfile) (*mtproto.User, error) {
	...
	c.Logger.Debugf("account.updateProfile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.updateProfile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountUpdateStatus(ctx context.Context, request *mtproto.TLAccountUpdateStatus) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.updateStatus - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.updateStatus - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountGetPrivacy(ctx context.Context, request *mtproto.TLAccountGetPrivacy) (*mtproto.Account_PrivacyRules, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.getPrivacy - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.getPrivacy - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountSetPrivacy(ctx context.Context, request *mtproto.TLAccountSetPrivacy) (*mtproto.Account_PrivacyRules, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.setPrivacy - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.setPrivacy - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountDeleteAccount(ctx context.Context, request *mtproto.TLAccountDeleteAccount) (*mtproto.Bool, error) {
	...
	c.Logger.Debugf("account.deleteAccount - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountGetAccountTTL(ctx context.Context, request *mtproto.TLAccountGetAccountTTL) (*mtproto.AccountDaysTTL, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.getAccountTTL - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.getAccountTTL - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountSetAccountTTL(ctx context.Context, request *mtproto.TLAccountSetAccountTTL) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.setAccountTTL - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.setAccountTTL - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountSendChangePhoneCode(ctx context.Context, request *mtproto.TLAccountSendChangePhoneCode) (*mtproto.Auth_SentCode, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.sendChangePhoneCode - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.sendChangePhoneCode - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountChangePhone(ctx context.Context, request *mtproto.TLAccountChangePhone) (*mtproto.User, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.changePhone - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.changePhone - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountResetAuthorization(ctx context.Context, request *mtproto.TLAccountResetAuthorization) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.resetAuthorization - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.resetAuthorization - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountSendConfirmPhoneCode(ctx context.Context, request *mtproto.TLAccountSendConfirmPhoneCode) (*mtproto.Auth_SentCode, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.sendConfirmPhoneCode - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.sendConfirmPhoneCode - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountConfirmPhone(ctx context.Context, request *mtproto.TLAccountConfirmPhone) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.confirmPhone - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.confirmPhone - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountGetGlobalPrivacySettings(ctx context.Context, request *mtproto.TLAccountGetGlobalPrivacySettings) (*mtproto.GlobalPrivacySettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.getGlobalPrivacySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.getGlobalPrivacySettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) AccountSetGlobalPrivacySettings(ctx context.Context, request *mtproto.TLAccountSetGlobalPrivacySettings) (*mtproto.GlobalPrivacySettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.setGlobalPrivacySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
...
func (s *Service) AccountUpdateVerified(ctx context.Context, request *mtproto.TLAccountUpdateVerified) (*mtproto.User, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("account.updateVerified - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("account.updateVerified - reply: %s", r.DebugString())
	return r, err
}
