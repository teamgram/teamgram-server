...
func (c *NsfwCore) AccountGetContentSettings(in *tg.TLAccountGetContentSettings) (*tg.AccountContentSettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("account.getContentSettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("account.getContentSettings not implemented")
}
