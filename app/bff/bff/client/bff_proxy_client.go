...
func (c *BFFProxyClient) Invoke(rpcMetaData *metadata.RpcMetadata, object iface.TLObject) (iface.TLObject, error) {
	return c.InvokeContext(context.Background(), rpcMetaData, object)
}

// InvokeContext 通用grpc转发器
func (c *BFFProxyClient) InvokeContext(ctx context.Context, rpcMetaData *metadata.RpcMetadata, object iface.TLObject) (iface.TLObject, error) {
