...
func (c *AutoDownloadCore) AccountGetAutoDownloadSettings(in *tg.TLAccountGetAutoDownloadSettings) (*tg.AccountAutoDownloadSettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("account.getAutoDownloadSettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("account.getAutoDownloadSettings not implemented")
}
