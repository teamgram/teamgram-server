...
func (c *DfsCore) DfsUploadPhotoFileV2(in *dfs.TLDfsUploadPhotoFileV2) (*tg.Photo, error) {
	// TODO: not impl
	// c.Logger.Errorf("dfs.uploadPhotoFileV2 blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("dfs.uploadPhotoFileV2 not implemented")
}
