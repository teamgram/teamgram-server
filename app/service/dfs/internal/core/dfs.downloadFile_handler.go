...
func (c *DfsCore) DfsDownloadFile(in *dfs.TLDfsDownloadFile) (*tg.UploadFile, error) {
	// TODO: not impl
	// c.Logger.Errorf("dfs.downloadFile blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("dfs.downloadFile not implemented")
}
