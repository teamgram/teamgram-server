...
func (c *DfsCore) DfsUploadedProfilePhoto(in *dfs.TLDfsUploadedProfilePhoto) (*tg.Photo, error) {
	// TODO: not impl
	// c.Logger.Errorf("dfs.uploadedProfilePhoto blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("dfs.uploadedProfilePhoto not implemented")
}
