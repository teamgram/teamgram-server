...
func (c *DfsCore) DfsUploadThemeFile(in *dfs.TLDfsUploadThemeFile) (*tg.Document, error) {
	// TODO: not impl
	// c.Logger.Errorf("dfs.uploadThemeFile blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("dfs.uploadThemeFile not implemented")
}
