...
func (c *DfsCore) DfsUploadGifDocumentMedia(in *dfs.TLDfsUploadGifDocumentMedia) (*tg.Document, error) {
	// TODO: not impl
	// c.Logger.Errorf("dfs.uploadGifDocumentMedia blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("dfs.uploadGifDocumentMedia not implemented")
}
