...
func (c *DfsCore) DfsUploadWallPaperFile(in *dfs.TLDfsUploadWallPaperFile) (*tg.Document, error) {
	// TODO: not impl
	// c.Logger.Errorf("dfs.uploadWallPaperFile blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("dfs.uploadWallPaperFile not implemented")
}
