...
func (c *IdgenCore) IdgenGetNextIdValList(in *idgen.TLIdgenGetNextIdValList) (*idgen.VectorIdVal, error) {
	// TODO: not impl
	// c.Logger.Errorf("idgen.getNextIdValList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("idgen.getNextIdValList not implemented")
}
