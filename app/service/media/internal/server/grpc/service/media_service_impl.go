...
func (s *Service) MediaUploadPhotoFile(ctx context.Context, request *media.TLMediaUploadPhotoFile) (*mtproto.Photo, error) {
	...
	c.Logger.Debugf("media.uploadPhotoFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadPhotoFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadProfilePhotoFile(ctx context.Context, request *media.TLMediaUploadProfilePhotoFile) (*mtproto.Photo, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.uploadProfilePhotoFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadProfilePhotoFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetPhoto(ctx context.Context, request *media.TLMediaGetPhoto) (*mtproto.Photo, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.getPhoto - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.getPhoto - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetPhotoSizeList(ctx context.Context, request *media.TLMediaGetPhotoSizeList) (*media.PhotoSizeList, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.getPhotoSizeList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.getPhotoSizeList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetPhotoSizeListList(ctx context.Context, request *media.TLMediaGetPhotoSizeListList) (*media.Vector_PhotoSizeList, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.getPhotoSizeListList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.getPhotoSizeListList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetVideoSizeList(ctx context.Context, request *media.TLMediaGetVideoSizeList) (*media.VideoSizeList, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.getVideoSizeList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
...
func (s *Service) MediaUploadedDocumentMedia(ctx context.Context, request *media.TLMediaUploadedDocumentMedia) (*mtproto.MessageMedia, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.uploadedDocumentMedia - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadedDocumentMedia - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetDocument(ctx context.Context, request *media.TLMediaGetDocument) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.getDocument - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.getDocument - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetDocumentList(ctx context.Context, request *media.TLMediaGetDocumentList) (*media.Vector_Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.getDocumentList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.getDocumentList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadEncryptedFile(ctx context.Context, request *media.TLMediaUploadEncryptedFile) (*mtproto.EncryptedFile, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.uploadEncryptedFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadEncryptedFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetEncryptedFile(ctx context.Context, request *media.TLMediaGetEncryptedFile) (*mtproto.EncryptedFile, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.getEncryptedFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.getEncryptedFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadWallPaperFile(ctx context.Context, request *media.TLMediaUploadWallPaperFile) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.uploadWallPaperFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadWallPaperFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadThemeFile(ctx context.Context, request *media.TLMediaUploadThemeFile) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.uploadThemeFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadThemeFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadStickerFile(ctx context.Context, request *media.TLMediaUploadStickerFile) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.uploadStickerFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadStickerFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadRingtoneFile(ctx context.Context, request *media.TLMediaUploadRingtoneFile) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("media.uploadRingtoneFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("media.uploadRingtoneFile - reply: %s", r.DebugString())
	return r, err
}
