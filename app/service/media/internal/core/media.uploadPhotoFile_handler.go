...
func (c *MediaCore) MediaUploadPhotoFile(in *media.TLMediaUploadPhotoFile) (*tg.Photo, error) {
	// TODO: not impl
	// c.Logger.Errorf("media.uploadPhotoFile blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("media.uploadPhotoFile not implemented")
}
