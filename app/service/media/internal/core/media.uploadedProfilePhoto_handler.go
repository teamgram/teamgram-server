...
func (c *MediaCore) MediaUploadedProfilePhoto(in *media.TLMediaUploadedProfilePhoto) (*tg.Photo, error) {
	// TODO: not impl
	// c.Logger.Errorf("media.uploadedProfilePhoto blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("media.uploadedProfilePhoto not implemented")
}
