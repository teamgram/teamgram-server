...
func (c *MediaCore) MediaGetPhotoSizeListList(in *media.TLMediaGetPhotoSizeListList) (*media.VectorPhotoSizeList, error) {
	// TODO: not impl
	// c.Logger.Errorf("media.getPhotoSizeListList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("media.getPhotoSizeListList not implemented")
}
