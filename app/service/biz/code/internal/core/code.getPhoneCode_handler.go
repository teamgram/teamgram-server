...
func (c *CodeCore) CodeGetPhoneCode(in *code.TLCodeGetPhoneCode) (*code.PhoneCodeTransaction, error) {
	// TODO: not impl
	// c.Logger.Errorf("code.getPhoneCode blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("code.getPhoneCode not implemented")
}
