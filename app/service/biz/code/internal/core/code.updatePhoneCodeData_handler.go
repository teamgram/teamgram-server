...
func (c *CodeCore) CodeUpdatePhoneCodeData(in *code.TLCodeUpdatePhoneCodeData) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("code.updatePhoneCodeData blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("code.updatePhoneCodeData not implemented")
}
