...
func (c *CodeCore) CodeDeletePhoneCode(in *code.TLCodeDeletePhoneCode) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("code.deletePhoneCode blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("code.deletePhoneCode not implemented")
}
