...
func (c *UsernameCore) UsernameCheckAccountUsername(in *username.TLUsernameCheckAccountUsername) (*username.UsernameExist, error) {
	// TODO: not impl
	// c.Logger.Errorf("username.checkAccountUsername blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("username.checkAccountUsername not implemented")
}
