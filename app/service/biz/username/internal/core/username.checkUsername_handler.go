...
func (c *UsernameCore) UsernameCheckUsername(in *username.TLUsernameCheckUsername) (*username.UsernameExist, error) {
	// TODO: not impl
	// c.Logger.Errorf("username.checkUsername blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("username.checkUsername not implemented")
}
