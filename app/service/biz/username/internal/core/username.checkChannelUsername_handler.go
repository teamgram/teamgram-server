...
func (c *UsernameCore) UsernameCheckChannelUsername(in *username.TLUsernameCheckChannelUsername) (*username.UsernameExist, error) {
	// TODO: not impl
	// c.Logger.Errorf("username.checkChannelUsername blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("username.checkChannelUsername not implemented")
}
