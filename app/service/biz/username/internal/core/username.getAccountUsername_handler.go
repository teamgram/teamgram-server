...
func (c *UsernameCore) UsernameGetAccountUsername(in *username.TLUsernameGetAccountUsername) (*username.UsernameData, error) {
	// TODO: not impl
	// c.Logger.Errorf("username.getAccountUsername blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("username.getAccountUsername not implemented")
}
