...
func (c *UsernameCore) UsernameGetChannelUsername(in *username.TLUsernameGetChannelUsername) (*username.UsernameData, error) {
	// TODO: not impl
	// c.Logger.Errorf("username.getChannelUsername blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("username.getChannelUsername not implemented")
}
