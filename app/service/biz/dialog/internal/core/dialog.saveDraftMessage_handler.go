...
func (c *DialogCore) DialogSaveDraftMessage(in *dialog.TLDialogSaveDraftMessage) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("dialog.saveDraftMessage blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("dialog.saveDraftMessage not implemented")
}
