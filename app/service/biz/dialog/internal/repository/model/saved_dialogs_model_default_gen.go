...
var (
	...
	cacheSavedDialogsIdPrefix = "cache#SavedDialogs#id"

	cacheSavedDialogsUserIdPeerTypePeerIdPrefix = "cache#UserId#PeerType#PeerId"
)
...
func (m *defaultSavedDialogsModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s#%v", cacheSavedDialogsIdPrefix, primary)
}
