...
func (c *UserCore) UserIsBot(in *user.TLUserIsBot) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.isBot blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.isBot not implemented")
}
