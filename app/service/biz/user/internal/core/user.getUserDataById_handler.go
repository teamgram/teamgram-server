...
func (c *UserCore) UserGetUserDataById(in *user.TLUserGetUserDataById) (*tg.UserData, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getUserDataById blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getUserDataById not implemented")
}
