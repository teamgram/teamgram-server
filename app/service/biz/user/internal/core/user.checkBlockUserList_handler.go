...
func (c *UserCore) UserCheckBlockUserList(in *user.TLUserCheckBlockUserList) (*user.VectorLong, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.checkBlockUserList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.checkBlockUserList not implemented")
}
