...
func (c *UserCore) UserGetLastSeen(in *user.TLUserGetLastSeen) (*user.LastSeenData, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getLastSeen blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getLastSeen not implemented")
}
