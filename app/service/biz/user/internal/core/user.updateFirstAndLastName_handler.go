...
func (c *UserCore) UserUpdateFirstAndLastName(in *user.TLUserUpdateFirstAndLastName) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.updateFirstAndLastName blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.updateFirstAndLastName not implemented")
}
