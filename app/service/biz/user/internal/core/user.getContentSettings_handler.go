...
func (c *UserCore) UserGetContentSettings(in *user.TLUserGetContentSettings) (*tg.AccountContentSettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getContentSettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getContentSettings not implemented")
}
