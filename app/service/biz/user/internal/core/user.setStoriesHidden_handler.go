...
func (c *UserCore) UserSetStoriesHidden(in *user.TLUserSetStoriesHidden) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.setStoriesHidden blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.setStoriesHidden not implemented")
}
