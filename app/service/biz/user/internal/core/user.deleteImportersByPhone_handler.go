...
func (c *UserCore) UserDeleteImportersByPhone(in *user.TLUserDeleteImportersByPhone) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.deleteImportersByPhone blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.deleteImportersByPhone not implemented")
}
