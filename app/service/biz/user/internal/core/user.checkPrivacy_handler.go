...
func (c *UserCore) UserCheckPrivacy(in *user.TLUserCheckPrivacy) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.checkPrivacy blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.checkPrivacy not implemented")
}
