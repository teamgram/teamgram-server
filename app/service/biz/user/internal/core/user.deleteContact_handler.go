...
func (c *UserCore) UserDeleteContact(in *user.TLUserDeleteContact) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.deleteContact blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.deleteContact not implemented")
}
