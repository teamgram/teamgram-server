...
func (c *UserCore) UserGetImportersByPhone(in *user.TLUserGetImportersByPhone) (*user.VectorInputContact, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getImportersByPhone blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getImportersByPhone not implemented")
}
