...
func (c *UserCore) UserIsBlockedByUser(in *user.TLUserIsBlockedByUser) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.isBlockedByUser blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.isBlockedByUser not implemented")
}
