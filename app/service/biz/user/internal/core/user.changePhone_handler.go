...
func (c *UserCore) UserChangePhone(in *user.TLUserChangePhone) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.changePhone blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.changePhone not implemented")
}
