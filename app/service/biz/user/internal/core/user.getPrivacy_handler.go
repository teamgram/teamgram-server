...
func (c *UserCore) UserGetPrivacy(in *user.TLUserGetPrivacy) (*user.VectorPrivacyRule, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getPrivacy blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getPrivacy not implemented")
}
