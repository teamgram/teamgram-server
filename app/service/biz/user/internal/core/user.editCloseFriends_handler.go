...
func (c *UserCore) UserEditCloseFriends(in *user.TLUserEditCloseFriends) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.editCloseFriends blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.editCloseFriends not implemented")
}
