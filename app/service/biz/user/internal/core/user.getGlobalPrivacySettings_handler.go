...
func (c *UserCore) UserGetGlobalPrivacySettings(in *user.TLUserGetGlobalPrivacySettings) (*tg.GlobalPrivacySettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getGlobalPrivacySettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getGlobalPrivacySettings not implemented")
}
