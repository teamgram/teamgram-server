...
func (c *UserCore) UserGetBlockedList(in *user.TLUserGetBlockedList) (*user.VectorPeerBlocked, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getBlockedList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getBlockedList not implemented")
}
