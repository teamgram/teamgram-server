...
func (c *UserCore) UserCheckBots(in *user.TLUserCheckBots) (*user.VectorLong, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.checkBots blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.checkBots not implemented")
}
