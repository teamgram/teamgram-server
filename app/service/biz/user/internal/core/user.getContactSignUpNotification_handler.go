...
func (c *UserCore) UserGetContactSignUpNotification(in *user.TLUserGetContactSignUpNotification) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getContactSignUpNotification blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getContactSignUpNotification not implemented")
}
