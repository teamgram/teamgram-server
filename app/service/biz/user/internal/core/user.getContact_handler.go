...
func (c *UserCore) UserGetContact(in *user.TLUserGetContact) (*tg.ContactData, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getContact blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getContact not implemented")
}
