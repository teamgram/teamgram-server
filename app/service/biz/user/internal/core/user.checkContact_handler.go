...
func (c *UserCore) UserCheckContact(in *user.TLUserCheckContact) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.checkContact blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.checkContact not implemented")
}
