...
func (c *UserCore) UserSetColor(in *user.TLUserSetColor) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.setColor blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.setColor not implemented")
}
