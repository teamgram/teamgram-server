...
func (c *UserCore) UserGetImmutableUserByToken(in *user.TLUserGetImmutableUserByToken) (*tg.ImmutableUser, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getImmutableUserByToken blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getImmutableUserByToken not implemented")
}
