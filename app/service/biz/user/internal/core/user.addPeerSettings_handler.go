...
func (c *UserCore) UserAddPeerSettings(in *user.TLUserAddPeerSettings) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.addPeerSettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.addPeerSettings not implemented")
}
