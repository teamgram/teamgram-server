...
func (c *UserCore) UserUpdateUsername(in *user.TLUserUpdateUsername) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.updateUsername blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.updateUsername not implemented")
}
