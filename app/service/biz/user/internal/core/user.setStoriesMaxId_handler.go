...
func (c *UserCore) UserSetStoriesMaxId(in *user.TLUserSetStoriesMaxId) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.setStoriesMaxId blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.setStoriesMaxId not implemented")
}
