...
func (c *UserCore) UserUpdatePremium(in *user.TLUserUpdatePremium) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.updatePremium blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.updatePremium not implemented")
}
