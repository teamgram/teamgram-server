...
func (c *UserCore) UserAddContact(in *user.TLUserAddContact) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.addContact blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.addContact not implemented")
}
