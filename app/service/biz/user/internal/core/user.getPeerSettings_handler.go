...
func (c *UserCore) UserGetPeerSettings(in *user.TLUserGetPeerSettings) (*tg.PeerSettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getPeerSettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getPeerSettings not implemented")
}
