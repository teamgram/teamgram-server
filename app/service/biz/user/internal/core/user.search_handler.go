...
func (c *UserCore) UserSearch(in *user.TLUserSearch) (*user.UsersFound, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.search blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.search not implemented")
}
