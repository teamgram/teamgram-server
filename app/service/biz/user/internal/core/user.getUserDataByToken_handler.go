...
func (c *UserCore) UserGetUserDataByToken(in *user.TLUserGetUserDataByToken) (*tg.UserData, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getUserDataByToken blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getUserDataByToken not implemented")
}
