...
func (c *UserCore) UserUnBlockPeer(in *user.TLUserUnBlockPeer) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.unBlockPeer blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.unBlockPeer not implemented")
}
