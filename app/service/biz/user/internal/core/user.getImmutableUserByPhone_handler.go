...
func (c *UserCore) UserGetImmutableUserByPhone(in *user.TLUserGetImmutableUserByPhone) (*tg.ImmutableUser, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getImmutableUserByPhone blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getImmutableUserByPhone not implemented")
}
