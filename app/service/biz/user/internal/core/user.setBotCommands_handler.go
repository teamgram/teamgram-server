...
func (c *UserCore) UserSetBotCommands(in *user.TLUserSetBotCommands) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.setBotCommands blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.setBotCommands not implemented")
}
