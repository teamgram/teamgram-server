...
func (c *UserCore) UserResetNotifySettings(in *user.TLUserResetNotifySettings) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.resetNotifySettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.resetNotifySettings not implemented")
}
