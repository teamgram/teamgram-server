...
func (c *UserCore) UserSetContentSettings(in *user.TLUserSetContentSettings) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.setContentSettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.setContentSettings not implemented")
}
