...
func (c *UserCore) UserGetAuthorizationTTL(in *user.TLUserGetAuthorizationTTL) (*tg.AccountDaysTTL, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getAuthorizationTTL blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getAuthorizationTTL not implemented")
}
