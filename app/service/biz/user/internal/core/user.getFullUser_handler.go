...
func (c *UserCore) UserGetFullUser(in *user.TLUserGetFullUser) (*tg.UsersUserFull, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getFullUser blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getFullUser not implemented")
}
