...
func (c *UserCore) UserCreateNewTestUser(in *user.TLUserCreateNewTestUser) (*tg.ImmutableUser, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.createNewTestUser blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.createNewTestUser not implemented")
}
