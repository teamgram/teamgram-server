...
func (c *UserCore) UserSetGlobalPrivacySettings(in *user.TLUserSetGlobalPrivacySettings) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.setGlobalPrivacySettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.setGlobalPrivacySettings not implemented")
}
