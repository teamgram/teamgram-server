...
func (c *UserCore) UserGetContactIdList(in *user.TLUserGetContactIdList) (*user.VectorLong, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getContactIdList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getContactIdList not implemented")
}
