...
func (c *UserCore) UserUpdateBirthday(in *user.TLUserUpdateBirthday) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.updateBirthday blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.updateBirthday not implemented")
}
