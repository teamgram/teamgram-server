...
func (c *UserCore) UserGetMutableUsers(in *user.TLUserGetMutableUsers) (*user.VectorImmutableUser, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getMutableUsers blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getMutableUsers not implemented")
}
