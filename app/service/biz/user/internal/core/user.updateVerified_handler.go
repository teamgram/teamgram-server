...
func (c *UserCore) UserUpdateVerified(in *user.TLUserUpdateVerified) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.updateVerified blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.updateVerified not implemented")
}
