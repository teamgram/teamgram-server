...
func (c *UserCore) UserUpdateProfilePhoto(in *user.TLUserUpdateProfilePhoto) (*tg.Int64, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.updateProfilePhoto blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.updateProfilePhoto not implemented")
}
