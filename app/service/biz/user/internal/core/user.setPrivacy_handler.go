...
func (c *UserCore) UserSetPrivacy(in *user.TLUserSetPrivacy) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.setPrivacy blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.setPrivacy not implemented")
}
