...
func (c *UserCore) UserGetAllNotifySettings(in *user.TLUserGetAllNotifySettings) (*user.VectorPeerPeerNotifySettings, error) {
	// TODO: not impl
	// c.Logger.Errorf("user.getAllNotifySettings blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("user.getAllNotifySettings not implemented")
}
