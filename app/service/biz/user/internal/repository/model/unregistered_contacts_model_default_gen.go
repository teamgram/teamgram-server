...
var (
	...
	cacheUnregisteredContactsIdPrefix = "cache#UnregisteredContacts#id"

	cacheUnregisteredContactsPhoneImporterUserIdPrefix = "cache#Phone#ImporterUserId"
)
...
func (m *defaultUnregisteredContactsModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s#%v", cacheUnregisteredContactsIdPrefix, primary)
}
