...
func (s *Service) UserCreateNewPredefinedUser(ctx context.Context, request *user.TLUserCreateNewPredefinedUser) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.createNewPredefinedUser - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.createNewPredefinedUser - reply: %s", r)
	return r, err
}
...
func (s *Service) UserGetPredefinedUser(ctx context.Context, request *user.TLUserGetPredefinedUser) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getPredefinedUser - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.getPredefinedUser - reply: %s", r)
	return r, err
}
...
func (s *Service) UserGetAllPredefinedUser(ctx context.Context, request *user.TLUserGetAllPredefinedUser) (*user.Vector_PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getAllPredefinedUser - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.getAllPredefinedUser - reply: %s", r)
	return r, err
}
...
func (s *Service) UserUpdatePredefinedFirstAndLastName(ctx context.Context, request *user.TLUserUpdatePredefinedFirstAndLastName) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedFirstAndLastName - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.updatePredefinedFirstAndLastName - reply: %s", r)
	return r, err
}
...
func (s *Service) UserUpdatePredefinedVerified(ctx context.Context, request *user.TLUserUpdatePredefinedVerified) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedVerified - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.updatePredefinedVerified - reply: %s", r)
	return r, err
}
...
func (s *Service) UserUpdatePredefinedUsername(ctx context.Context, request *user.TLUserUpdatePredefinedUsername) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedUsername - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.updatePredefinedUsername - reply: %s", r)
	return r, err
}
...
func (s *Service) UserUpdatePredefinedCode(ctx context.Context, request *user.TLUserUpdatePredefinedCode) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedCode - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.updatePredefinedCode - reply: %s", r)
	return r, err
}
...
func (s *Service) UserPredefinedBindRegisteredUserId(ctx context.Context, request *user.TLUserPredefinedBindRegisteredUserId) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.predefinedBindRegisteredUserId - metadata: %s, request: %s", c.MD, request)
	...
	c.Logger.Debugf("user.predefinedBindRegisteredUserId - reply: %s", r)
	return r, err
}
