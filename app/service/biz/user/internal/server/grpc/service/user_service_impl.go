...
func (s *Service) UserGetLastSeens(ctx context.Context, request *user.TLUserGetLastSeens) (*user.Vector_LastSeenData, error) {
	...
	c.Logger.Debugf("user.getLastSeens - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getLastSeens - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdateLastSeen(ctx context.Context, request *user.TLUserUpdateLastSeen) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updateLastSeen - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updateLastSeen - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetLastSeen(ctx context.Context, request *user.TLUserGetLastSeen) (*user.LastSeenData, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getLastSeen - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getLastSeen - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetImmutableUser(ctx context.Context, request *user.TLUserGetImmutableUser) (*user.ImmutableUser, error) {
	...
	c.Logger.Debugf("user.getImmutableUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetMutableUsers(ctx context.Context, request *user.TLUserGetMutableUsers) (*user.Vector_ImmutableUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getMutableUsers - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getMutableUsers - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetImmutableUserByPhone(ctx context.Context, request *user.TLUserGetImmutableUserByPhone) (*user.ImmutableUser, error) {
	...
	c.Logger.Debugf("user.getImmutableUserByPhone - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetImmutableUserByToken(ctx context.Context, request *user.TLUserGetImmutableUserByToken) (*user.ImmutableUser, error) {
	...
	c.Logger.Debugf("user.getImmutableUserByToken - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserSetAccountDaysTTL(ctx context.Context, request *user.TLUserSetAccountDaysTTL) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.setAccountDaysTTL - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.setAccountDaysTTL - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetAccountDaysTTL(ctx context.Context, request *user.TLUserGetAccountDaysTTL) (*mtproto.AccountDaysTTL, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getAccountDaysTTL - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getAccountDaysTTL - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetNotifySettings(ctx context.Context, request *user.TLUserGetNotifySettings) (*mtproto.PeerNotifySettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getNotifySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getNotifySettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetNotifySettingsList(ctx context.Context, request *user.TLUserGetNotifySettingsList) (*user.Vector_PeerPeerNotifySettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getNotifySettingsList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getNotifySettingsList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserSetNotifySettings(ctx context.Context, request *user.TLUserSetNotifySettings) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.setNotifySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.setNotifySettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserResetNotifySettings(ctx context.Context, request *user.TLUserResetNotifySettings) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.resetNotifySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.resetNotifySettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetAllNotifySettings(ctx context.Context, request *user.TLUserGetAllNotifySettings) (*user.Vector_PeerPeerNotifySettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getAllNotifySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getAllNotifySettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetGlobalPrivacySettings(ctx context.Context, request *user.TLUserGetGlobalPrivacySettings) (*mtproto.GlobalPrivacySettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getGlobalPrivacySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getGlobalPrivacySettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserSetGlobalPrivacySettings(ctx context.Context, request *user.TLUserSetGlobalPrivacySettings) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.setGlobalPrivacySettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.setGlobalPrivacySettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetPrivacy(ctx context.Context, request *user.TLUserGetPrivacy) (*user.Vector_PrivacyRule, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getPrivacy - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getPrivacy - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserSetPrivacy(ctx context.Context, request *user.TLUserSetPrivacy) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.setPrivacy - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.setPrivacy - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserCheckPrivacy(ctx context.Context, request *user.TLUserCheckPrivacy) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.checkPrivacy - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.checkPrivacy - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserAddPeerSettings(ctx context.Context, request *user.TLUserAddPeerSettings) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.addPeerSettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.addPeerSettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetPeerSettings(ctx context.Context, request *user.TLUserGetPeerSettings) (*mtproto.PeerSettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getPeerSettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getPeerSettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserDeletePeerSettings(ctx context.Context, request *user.TLUserDeletePeerSettings) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.deletePeerSettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.deletePeerSettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserChangePhone(ctx context.Context, request *user.TLUserChangePhone) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.changePhone - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.changePhone - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserCreateNewPredefinedUser(ctx context.Context, request *user.TLUserCreateNewPredefinedUser) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.createNewPredefinedUser - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.createNewPredefinedUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetPredefinedUser(ctx context.Context, request *user.TLUserGetPredefinedUser) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getPredefinedUser - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getPredefinedUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetAllPredefinedUser(ctx context.Context, request *user.TLUserGetAllPredefinedUser) (*user.Vector_PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getAllPredefinedUser - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getAllPredefinedUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdatePredefinedFirstAndLastName(ctx context.Context, request *user.TLUserUpdatePredefinedFirstAndLastName) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedFirstAndLastName - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updatePredefinedFirstAndLastName - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdatePredefinedVerified(ctx context.Context, request *user.TLUserUpdatePredefinedVerified) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedVerified - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updatePredefinedVerified - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdatePredefinedUsername(ctx context.Context, request *user.TLUserUpdatePredefinedUsername) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedUsername - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updatePredefinedUsername - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdatePredefinedCode(ctx context.Context, request *user.TLUserUpdatePredefinedCode) (*mtproto.PredefinedUser, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updatePredefinedCode - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updatePredefinedCode - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserPredefinedBindRegisteredUserId(ctx context.Context, request *user.TLUserPredefinedBindRegisteredUserId) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.predefinedBindRegisteredUserId - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.predefinedBindRegisteredUserId - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserCreateNewUser(ctx context.Context, request *user.TLUserCreateNewUser) (*user.ImmutableUser, error) {
	...
	c.Logger.Debugf("user.createNewUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserBlockPeer(ctx context.Context, request *user.TLUserBlockPeer) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.blockPeer - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.blockPeer - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUnBlockPeer(ctx context.Context, request *user.TLUserUnBlockPeer) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.unBlockPeer - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.unBlockPeer - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserBlockedByUser(ctx context.Context, request *user.TLUserBlockedByUser) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.blockedByUser - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.blockedByUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserIsBlockedByUser(ctx context.Context, request *user.TLUserIsBlockedByUser) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.isBlockedByUser - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.isBlockedByUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserCheckBlockUserList(ctx context.Context, request *user.TLUserCheckBlockUserList) (*user.Vector_Long, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.checkBlockUserList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.checkBlockUserList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetBlockedList(ctx context.Context, request *user.TLUserGetBlockedList) (*user.Vector_PeerBlocked, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getBlockedList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getBlockedList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetContactSignUpNotification(ctx context.Context, request *user.TLUserGetContactSignUpNotification) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getContactSignUpNotification - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getContactSignUpNotification - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserSetContactSignUpNotification(ctx context.Context, request *user.TLUserSetContactSignUpNotification) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.setContactSignUpNotification - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.setContactSignUpNotification - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetContentSettings(ctx context.Context, request *user.TLUserGetContentSettings) (*mtproto.Account_ContentSettings, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getContentSettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getContentSettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserSetContentSettings(ctx context.Context, request *user.TLUserSetContentSettings) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.setContentSettings - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.setContentSettings - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserDeleteContact(ctx context.Context, request *user.TLUserDeleteContact) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.deleteContact - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.deleteContact - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetContactList(ctx context.Context, request *user.TLUserGetContactList) (*user.Vector_ContactData, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getContactList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getContactList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetContactIdList(ctx context.Context, request *user.TLUserGetContactIdList) (*user.Vector_Long, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getContactIdList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getContactIdList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetContact(ctx context.Context, request *user.TLUserGetContact) (*user.ContactData, error) {
	...
	c.Logger.Debugf("user.getContact - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserAddContact(ctx context.Context, request *user.TLUserAddContact) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.addContact - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.addContact - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserCheckContact(ctx context.Context, request *user.TLUserCheckContact) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.checkContact - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.checkContact - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserImportContacts(ctx context.Context, request *user.TLUserImportContacts) (*user.UserImportedContacts, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.importContacts - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.importContacts - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetCountryCode(ctx context.Context, request *user.TLUserGetCountryCode) (*mtproto.String, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getCountryCode - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getCountryCode - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdateAbout(ctx context.Context, request *user.TLUserUpdateAbout) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updateAbout - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updateAbout - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdateFirstAndLastName(ctx context.Context, request *user.TLUserUpdateFirstAndLastName) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updateFirstAndLastName - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updateFirstAndLastName - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdateVerified(ctx context.Context, request *user.TLUserUpdateVerified) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updateVerified - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updateVerified - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdateUsername(ctx context.Context, request *user.TLUserUpdateUsername) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updateUsername - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updateUsername - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdateProfilePhoto(ctx context.Context, request *user.TLUserUpdateProfilePhoto) (*mtproto.Int64, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updateProfilePhoto - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.updateProfilePhoto - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserDeleteProfilePhotos(ctx context.Context, request *user.TLUserDeleteProfilePhotos) (*mtproto.Int64, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.deleteProfilePhotos - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.deleteProfilePhotos - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetProfilePhotos(ctx context.Context, request *user.TLUserGetProfilePhotos) (*user.Vector_Long, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getProfilePhotos - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getProfilePhotos - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserSetBotCommands(ctx context.Context, request *user.TLUserSetBotCommands) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.setBotCommands - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.setBotCommands - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserIsBot(ctx context.Context, request *user.TLUserIsBot) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.isBot - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.isBot - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetBotInfo(ctx context.Context, request *user.TLUserGetBotInfo) (*mtproto.BotInfo, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getBotInfo - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getBotInfo - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserGetFullUser(ctx context.Context, request *user.TLUserGetFullUser) (*mtproto.Users_UserFull, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.getFullUser - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Logger.Debugf("user.getFullUser - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) UserUpdateEmojiStatus(ctx context.Context, request *user.TLUserUpdateEmojiStatus) (*mtproto.Bool, error) {
	c := core.New(ctx, s.svcCtx)
	c.Logger.Debugf("user.updateEmojiStatus - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
