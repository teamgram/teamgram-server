 ...
 *
 * Copyright (c) 2022-present,  Teamgooo Authors.
 *  All rights reserved.
 *
...
// TODO(@benqi): sqlmap
func (dao *UserNotifySettingsDAO) SelectListWithCB(ctx context.Context, userId int64, peers []*tg.PeerUtil, cb func(i int, v *dataobject.UserNotifySettingsDO)) (rList []dataobject.UserNotifySettingsDO, err error) {
	var (
		qVs                                   []string
		args                                  []interface{}
		a                                     []interface{}
