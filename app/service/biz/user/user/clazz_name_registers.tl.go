...
const (
	...
	ClazzName_user_saveMusic                     = "user_saveMusic"
	ClazzName_user_getSavedMusicIdList           = "user_getSavedMusicIdList"
	ClazzName_user_setMainProfileTab             = "user_setMainProfileTab"
	ClazzName_user_setDefaultHistoryTTL          = "user_setDefaultHistoryTTL"
	ClazzName_user_getDefaultHistoryTTL          = "user_getDefaultHistoryTTL"
	ClazzName_user_getAccountUsername            = "user_getAccountUsername"
	ClazzName_user_checkAccountUsername          = "user_checkAccountUsername"
	ClazzName_user_getChannelUsername            = "user_getChannelUsername"
	ClazzName_user_checkChannelUsername          = "user_checkChannelUsername"
	ClazzName_user_updateUsernameByPeer          = "user_updateUsernameByPeer"
	ClazzName_user_checkUsername                 = "user_checkUsername"
	ClazzName_user_updateUsernameByUsername      = "user_updateUsernameByUsername"
	ClazzName_user_deleteUsername                = "user_deleteUsername"
	ClazzName_user_resolveUsername               = "user_resolveUsername"
	ClazzName_user_getListByUsernameList         = "user_getListByUsernameList"
	ClazzName_user_deleteUsernameByPeer          = "user_deleteUsernameByPeer"
	ClazzName_user_searchUsername                = "user_searchUsername"
	ClazzName_user_toggleUsername                = "user_toggleUsername"
	ClazzName_user_reorderUsernames              = "user_reorderUsernames"
	ClazzName_user_deactivateAllChannelUsernames = "user_deactivateAllChannelUsernames"
)
...
func init() {
	...
	iface.RegisterClazzName(ClazzName_user_saveMusic, 0, 0xda28349)                      // da28349
	iface.RegisterClazzName(ClazzName_user_getSavedMusicIdList, 0, 0x5b4ac25f)           // 5b4ac25f
	iface.RegisterClazzName(ClazzName_user_setMainProfileTab, 0, 0x9d48a89c)             // 9d48a89c
	iface.RegisterClazzName(ClazzName_user_setDefaultHistoryTTL, 0, 0x8f09517f)          // 8f09517f
	iface.RegisterClazzName(ClazzName_user_getDefaultHistoryTTL, 0, 0x4d4c2fe0)          // 4d4c2fe0
	iface.RegisterClazzName(ClazzName_user_getAccountUsername, 0, 0xff8b61cf)            // ff8b61cf
	iface.RegisterClazzName(ClazzName_user_checkAccountUsername, 0, 0xefe05198)          // efe05198
	iface.RegisterClazzName(ClazzName_user_getChannelUsername, 0, 0x910ac7b1)            // 910ac7b1
	iface.RegisterClazzName(ClazzName_user_checkChannelUsername, 0, 0xfecbacb6)          // fecbacb6
	iface.RegisterClazzName(ClazzName_user_updateUsernameByPeer, 0, 0xe3a0e9e2)          // e3a0e9e2
	iface.RegisterClazzName(ClazzName_user_checkUsername, 0, 0x3475e700)                 // 3475e700
	iface.RegisterClazzName(ClazzName_user_updateUsernameByUsername, 0, 0x13841a86)      // 13841a86
	iface.RegisterClazzName(ClazzName_user_deleteUsername, 0, 0x85e677a4)                // 85e677a4
	iface.RegisterClazzName(ClazzName_user_resolveUsername, 0, 0x4527d121)               // 4527d121
	iface.RegisterClazzName(ClazzName_user_getListByUsernameList, 0, 0x6e606b62)         // 6e606b62
	iface.RegisterClazzName(ClazzName_user_deleteUsernameByPeer, 0, 0x7cafbc1)           // 7cafbc1
	iface.RegisterClazzName(ClazzName_user_searchUsername, 0, 0x266eb885)                // 266eb885
	iface.RegisterClazzName(ClazzName_user_toggleUsername, 0, 0xdd3b5a14)                // dd3b5a14
	iface.RegisterClazzName(ClazzName_user_reorderUsernames, 0, 0x3a61bdc0)              // 3a61bdc0
	...
	iface.RegisterClazzIDName(ClazzName_user_saveMusic, 0xda28349)                      // da28349
	iface.RegisterClazzIDName(ClazzName_user_getSavedMusicIdList, 0x5b4ac25f)           // 5b4ac25f
	iface.RegisterClazzIDName(ClazzName_user_setMainProfileTab, 0x9d48a89c)             // 9d48a89c
	iface.RegisterClazzIDName(ClazzName_user_setDefaultHistoryTTL, 0x8f09517f)          // 8f09517f
	iface.RegisterClazzIDName(ClazzName_user_getDefaultHistoryTTL, 0x4d4c2fe0)          // 4d4c2fe0
	iface.RegisterClazzIDName(ClazzName_user_getAccountUsername, 0xff8b61cf)            // ff8b61cf
	iface.RegisterClazzIDName(ClazzName_user_checkAccountUsername, 0xefe05198)          // efe05198
	iface.RegisterClazzIDName(ClazzName_user_getChannelUsername, 0x910ac7b1)            // 910ac7b1
	iface.RegisterClazzIDName(ClazzName_user_checkChannelUsername, 0xfecbacb6)          // fecbacb6
	iface.RegisterClazzIDName(ClazzName_user_updateUsernameByPeer, 0xe3a0e9e2)          // e3a0e9e2
	iface.RegisterClazzIDName(ClazzName_user_checkUsername, 0x3475e700)                 // 3475e700
	iface.RegisterClazzIDName(ClazzName_user_updateUsernameByUsername, 0x13841a86)      // 13841a86
	iface.RegisterClazzIDName(ClazzName_user_deleteUsername, 0x85e677a4)                // 85e677a4
	iface.RegisterClazzIDName(ClazzName_user_resolveUsername, 0x4527d121)               // 4527d121
	iface.RegisterClazzIDName(ClazzName_user_getListByUsernameList, 0x6e606b62)         // 6e606b62
	iface.RegisterClazzIDName(ClazzName_user_deleteUsernameByPeer, 0x7cafbc1)           // 7cafbc1
	iface.RegisterClazzIDName(ClazzName_user_searchUsername, 0x266eb885)                // 266eb885
	iface.RegisterClazzIDName(ClazzName_user_toggleUsername, 0xdd3b5a14)                // dd3b5a14
	iface.RegisterClazzIDName(ClazzName_user_reorderUsernames, 0x3a61bdc0)              // 3a61bdc0
	iface.RegisterClazzIDName(ClazzName_user_deactivateAllChannelUsernames, 0x9a5fe53c) // 9a5fe53c
}
