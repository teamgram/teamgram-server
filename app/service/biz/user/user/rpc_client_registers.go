...
var rpcContextRegisters = map[string]RPCContextTuple{
	...
	"TLUserSetAuthorizationTTL":           RPCContextTuple{"/mtproto.RPCUser/user_setAuthorizationTTL", func() interface{} { return new(mtproto.Bool) }},
	"TLUserGetAuthorizationTTL":           RPCContextTuple{"/mtproto.RPCUser/user_getAuthorizationTTL", func() interface{} { return new(mtproto.AccountDaysTTL) }},
	"TLUserUpdatePremium":                 RPCContextTuple{"/mtproto.RPCUser/user_updatePremium", func() interface{} { return new(mtproto.Bool) }},
	"TLUserGetBotInfoV2":                  RPCContextTuple{"/mtproto.RPCUser/user_getBotInfoV2", func() interface{} { return new(BotInfoData) }},
	"TLUserSaveMusic":                     RPCContextTuple{"/mtproto.RPCUser/user_saveMusic", func() interface{} { return new(mtproto.Bool) }},
	"TLUserGetSavedMusicIdList":           RPCContextTuple{"/mtproto.RPCUser/user_getSavedMusicIdList", func() interface{} { return new(Vector_Long) }},
	"TLUserSetMainProfileTab":             RPCContextTuple{"/mtproto.RPCUser/user_setMainProfileTab", func() interface{} { return new(mtproto.Bool) }},
	"TLUserSetDefaultHistoryTTL":          RPCContextTuple{"/mtproto.RPCUser/user_setDefaultHistoryTTL", func() interface{} { return new(mtproto.Bool) }},
	"TLUserGetDefaultHistoryTTL":          RPCContextTuple{"/mtproto.RPCUser/user_getDefaultHistoryTTL", func() interface{} { return new(mtproto.DefaultHistoryTTL) }},
	"TLUserGetAccountUsername":            RPCContextTuple{"/mtproto.RPCUser/user_getAccountUsername", func() interface{} { return new(UsernameData) }},
	"TLUserCheckAccountUsername":          RPCContextTuple{"/mtproto.RPCUser/user_checkAccountUsername", func() interface{} { return new(UsernameExist) }},
	"TLUserGetChannelUsername":            RPCContextTuple{"/mtproto.RPCUser/user_getChannelUsername", func() interface{} { return new(UsernameData) }},
	"TLUserCheckChannelUsername":          RPCContextTuple{"/mtproto.RPCUser/user_checkChannelUsername", func() interface{} { return new(UsernameExist) }},
	"TLUserUpdateUsernameByPeer":          RPCContextTuple{"/mtproto.RPCUser/user_updateUsernameByPeer", func() interface{} { return new(mtproto.Bool) }},
	"TLUserCheckUsername":                 RPCContextTuple{"/mtproto.RPCUser/user_checkUsername", func() interface{} { return new(UsernameExist) }},
	"TLUserUpdateUsernameByUsername":      RPCContextTuple{"/mtproto.RPCUser/user_updateUsernameByUsername", func() interface{} { return new(mtproto.Bool) }},
	"TLUserDeleteUsername":                RPCContextTuple{"/mtproto.RPCUser/user_deleteUsername", func() interface{} { return new(mtproto.Bool) }},
	"TLUserResolveUsername":               RPCContextTuple{"/mtproto.RPCUser/user_resolveUsername", func() interface{} { return new(mtproto.Peer) }},
	"TLUserGetListByUsernameList":         RPCContextTuple{"/mtproto.RPCUser/user_getListByUsernameList", func() interface{} { return new(Vector_UsernameData) }},
	"TLUserDeleteUsernameByPeer":          RPCContextTuple{"/mtproto.RPCUser/user_deleteUsernameByPeer", func() interface{} { return new(mtproto.Bool) }},
	"TLUserSearchUsername":                RPCContextTuple{"/mtproto.RPCUser/user_searchUsername", func() interface{} { return new(Vector_UsernameData) }},
	"TLUserToggleUsername":                RPCContextTuple{"/mtproto.RPCUser/user_toggleUsername", func() interface{} { return new(mtproto.Bool) }},
	"TLUserReorderUsernames":              RPCContextTuple{"/mtproto.RPCUser/user_reorderUsernames", func() interface{} { return new(mtproto.Bool) }},
	"TLUserDeactivateAllChannelUsernames": RPCContextTuple{"/mtproto.RPCUser/user_deactivateAllChannelUsernames", func() interface{} { return new(mtproto.Bool) }},
}
