...
var rpcContextRegisters = map[string]RPCContextTuple{
	...
	"TLMessageGetScheduledMessageListByIdList":   RPCContextTuple{"/mtproto.RPCMessage/message_getScheduledMessageListByIdList", func() interface{} { return new(Vector_MessageBox) }},
	"TLMessageDeleteScheduledMessageList":        RPCContextTuple{"/mtproto.RPCMessage/message_deleteScheduledMessageList", func() interface{} { return new(mtproto.Bool) }},
	"TLMessageDeleteSentScheduledMessageList":    RPCContextTuple{"/mtproto.RPCMessage/message_deleteSentScheduledMessageList", func() interface{} { return new(mtproto.Bool) }},
	"TLMessageGetScheduledMessageHistory":        RPCContextTuple{"/mtproto.RPCMessage/message_getScheduledMessageHistory", func() interface{} { return new(Vector_MessageBox) }},
	"TLMessageGetScheduledTimeoutMessageList":    RPCContextTuple{"/mtproto.RPCMessage/message_getScheduledTimeoutMessageList", func() interface{} { return new(Vector_MessageBox) }},
	...
	"TLMessageGetChannelMessage":                 RPCContextTuple{"/mtproto.RPCMessage/message_getChannelMessage", func() interface{} { return new(mtproto.MessageBox) }},
	"TLMessageGetChannelMessageList":             RPCContextTuple{"/mtproto.RPCMessage/message_getChannelMessageList", func() interface{} { return new(Vector_MessageBox) }},
	"TLMessageGetChannelMessageListByDataIdList": RPCContextTuple{"/mtproto.RPCMessage/message_getChannelMessageListByDataIdList", func() interface{} { return new(Vector_MessageBox) }},
