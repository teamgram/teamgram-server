...
func (c *ChatCore) ChatGetChatInviteImporters(in *chat.TLChatGetChatInviteImporters) (*chat.VectorChatInviteImporter, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getChatInviteImporters blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getChatInviteImporters not implemented")
}
