...
func (c *ChatCore) ChatToggleNoForwards(in *chat.TLChatToggleNoForwards) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.toggleNoForwards blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.toggleNoForwards not implemented")
}
