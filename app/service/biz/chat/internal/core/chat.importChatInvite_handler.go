...
func (c *ChatCore) ChatImportChatInvite(in *chat.TLChatImportChatInvite) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.importChatInvite blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.importChatInvite not implemented")
}
