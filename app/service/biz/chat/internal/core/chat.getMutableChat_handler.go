...
func (c *ChatCore) ChatGetMutableChat(in *chat.TLChatGetMutableChat) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getMutableChat blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getMutableChat not implemented")
}
