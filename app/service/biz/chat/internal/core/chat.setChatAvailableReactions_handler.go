...
func (c *ChatCore) ChatSetChatAvailableReactions(in *chat.TLChatSetChatAvailableReactions) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.setChatAvailableReactions blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.setChatAvailableReactions not implemented")
}
