...
func (c *ChatCore) ChatGetChatParticipantIdList(in *chat.TLChatGetChatParticipantIdList) (*chat.VectorLong, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getChatParticipantIdList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getChatParticipantIdList not implemented")
}
