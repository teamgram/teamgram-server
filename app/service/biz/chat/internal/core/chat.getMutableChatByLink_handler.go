...
func (c *ChatCore) ChatGetMutableChatByLink(in *chat.TLChatGetMutableChatByLink) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getMutableChatByLink blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getMutableChatByLink not implemented")
}
