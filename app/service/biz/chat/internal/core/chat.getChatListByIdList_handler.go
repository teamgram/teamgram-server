...
func (c *ChatCore) ChatGetChatListByIdList(in *chat.TLChatGetChatListByIdList) (*chat.VectorMutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getChatListByIdList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getChatListByIdList not implemented")
}
