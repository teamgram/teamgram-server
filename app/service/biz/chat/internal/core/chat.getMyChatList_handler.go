...
func (c *ChatCore) ChatGetMyChatList(in *chat.TLChatGetMyChatList) (*chat.VectorMutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getMyChatList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getMyChatList not implemented")
}
