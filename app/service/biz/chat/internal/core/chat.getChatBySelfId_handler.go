...
func (c *ChatCore) ChatGetChatBySelfId(in *chat.TLChatGetChatBySelfId) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getChatBySelfId blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getChatBySelfId not implemented")
}
