...
func (c *ChatCore) ChatCheckChatInvite(in *chat.TLChatCheckChatInvite) (*chat.ChatInviteExt, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.checkChatInvite blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.checkChatInvite not implemented")
}
