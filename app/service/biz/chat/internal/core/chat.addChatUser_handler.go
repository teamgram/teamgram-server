...
func (c *ChatCore) ChatAddChatUser(in *chat.TLChatAddChatUser) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.addChatUser blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.addChatUser not implemented")
}
