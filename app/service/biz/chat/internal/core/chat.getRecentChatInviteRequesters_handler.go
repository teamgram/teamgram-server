...
func (c *ChatCore) ChatGetRecentChatInviteRequesters(in *chat.TLChatGetRecentChatInviteRequesters) (*chat.RecentChatInviteRequesters, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getRecentChatInviteRequesters blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getRecentChatInviteRequesters not implemented")
}
