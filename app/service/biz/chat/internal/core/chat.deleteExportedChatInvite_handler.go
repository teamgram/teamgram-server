...
func (c *ChatCore) ChatDeleteExportedChatInvite(in *chat.TLChatDeleteExportedChatInvite) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.deleteExportedChatInvite blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.deleteExportedChatInvite not implemented")
}
