...
func (c *ChatCore) ChatMigratedToChannel(in *chat.TLChatMigratedToChannel) (*tg.Bool, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.migratedToChannel blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.migratedToChannel not implemented")
}
