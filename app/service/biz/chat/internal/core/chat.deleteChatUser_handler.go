...
func (c *ChatCore) ChatDeleteChatUser(in *chat.TLChatDeleteChatUser) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.deleteChatUser blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.deleteChatUser not implemented")
}
