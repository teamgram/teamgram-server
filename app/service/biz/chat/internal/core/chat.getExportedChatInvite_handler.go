...
func (c *ChatCore) ChatGetExportedChatInvite(in *chat.TLChatGetExportedChatInvite) (*tg.ExportedChatInvite, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.getExportedChatInvite blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.getExportedChatInvite not implemented")
}
