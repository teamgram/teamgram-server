...
func (c *ChatCore) ChatEditChatTitle(in *chat.TLChatEditChatTitle) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.editChatTitle blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.editChatTitle not implemented")
}
