...
func (c *ChatCore) ChatEditChatDefaultBannedRights(in *chat.TLChatEditChatDefaultBannedRights) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.editChatDefaultBannedRights blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.editChatDefaultBannedRights not implemented")
}
