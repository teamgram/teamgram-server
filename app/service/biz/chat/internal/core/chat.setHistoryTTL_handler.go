...
func (c *ChatCore) ChatSetHistoryTTL(in *chat.TLChatSetHistoryTTL) (*tg.MutableChat, error) {
	// TODO: not impl
	// c.Logger.Errorf("chat.setHistoryTTL blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("chat.setHistoryTTL not implemented")
}
