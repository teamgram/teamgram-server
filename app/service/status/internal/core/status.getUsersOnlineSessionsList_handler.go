...
func (c *StatusCore) StatusGetUsersOnlineSessionsList(in *status.TLStatusGetUsersOnlineSessionsList) (*status.VectorUserSessionEntryList, error) {
	// TODO: not impl
	// c.Logger.Errorf("status.getUsersOnlineSessionsList blocked, License key from https://teamgram.net required to unlock enterprise features.")

	return nil, errors.New("status.getUsersOnlineSessionsList not implemented")
}
