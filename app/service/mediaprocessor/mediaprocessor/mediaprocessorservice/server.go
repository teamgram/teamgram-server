...
func NewServer(handler mediaprocessor.RPCMediaProcessor, opts ...server.Option) server.Server {
...
func RegisterService(svr server.Server, handler mediaprocessor.RPCMediaProcessor, opts ...server.RegisterOption) error {
