...
func NewServer(handler presence.RPCPresence, opts ...server.Option) server.Server {
...
func RegisterService(svr server.Server, handler presence.RPCPresence, opts ...server.RegisterOption) error {
