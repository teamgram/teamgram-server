...
func (m *TLAuthsessionSetAuthKey) Encode(x *bin.Encoder, layer int32) error {
	...
	case 0x3e940c91:
		...
		if err := m.AuthKey.Encode(x, layer); err != nil {
			return fmt.Errorf("unable to encode authsession_setAuthKey#0x3e940c91: field auth_key: %w", err)
		}
		if m.FutureSalt == nil {
		...
		if err := m.FutureSalt.Encode(x, layer); err != nil {
			return fmt.Errorf("unable to encode authsession_setAuthKey#0x3e940c91: field future_salt: %w", err)
		}
...
func (m *TLAuthsessionSetClientSessionInfo) Encode(x *bin.Encoder, layer int32) error {
	...
	case 0x2d9ff94:
		...
		if err := m.Data.Encode(x, layer); err != nil {
			return fmt.Errorf("unable to encode authsession_setClientSessionInfo#0x2d9ff94: field data: %w", err)
		}
