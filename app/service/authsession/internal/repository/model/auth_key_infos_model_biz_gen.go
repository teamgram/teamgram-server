...
type (
	bizAuthKeyInfosModel interface {
		Insert(ctx context.Context, data *AuthKeyInfos) (lastInsertId, rowsAffected int64, err error)
		InsertTx(tx *sqlx.Tx, data *AuthKeyInfos) (lastInsertId, rowsAffected int64, err error)

		SelectByAuthKeyId(ctx context.Context, authKeyId int64) (*AuthKeyInfos, error)
...
func (m *defaultAuthKeyInfosModel) Insert(ctx context.Context, data *AuthKeyInfos) (lastInsertId, rowsAffected int64, err error) {
	var (
...
// InsertTx
// insert into auth_key_infos(auth_key_id, auth_key_type, perm_auth_key_id, temp_auth_key_id, media_temp_auth_key_id) values (:auth_key_id, :auth_key_type, :perm_auth_key_id, :temp_auth_key_id, :media_temp_auth_key_id)
func (m *defaultAuthKeyInfosModel) InsertTx(tx *sqlx.Tx, data *AuthKeyInfos) (lastInsertId, rowsAffected int64, err error) {
	var (
		query = "insert into auth_key_infos(auth_key_id, auth_key_type, perm_auth_key_id, temp_auth_key_id, media_temp_auth_key_id) values (:auth_key_id, :auth_key_type, :perm_auth_key_id, :temp_auth_key_id, :media_temp_auth_key_id)"
		r     sql.Result
	)
...
func (m *defaultAuthKeyInfosModel) SelectByAuthKeyId(ctx context.Context, authKeyId int64) (rValue *AuthKeyInfos, err error) {
	var (
...
func (m *defaultAuthKeyInfosModel) UpdateCustomMap(ctx context.Context, cMap map[string]interface{}, authKeyId int64) (rowsAffected int64, err error) {
...
// UpdateCustomMapTx
// update auth_key_infos set %s where auth_key_id = :auth_key_id
func (m *defaultAuthKeyInfosModel) UpdateCustomMapTx(tx *sqlx.Tx, cMap map[string]interface{}, authKeyId int64) (rowsAffected int64, err error) {
	names := make([]string, 0, len(cMap))
	aValues := make([]interface{}, 0, len(cMap))
	for k, v := range cMap {
		names = append(names, k+" = ?")
