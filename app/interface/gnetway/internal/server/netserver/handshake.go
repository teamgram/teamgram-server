...
// //////////////////////////////////////////////////////////////////////////////////////////////////
func (s *Server) onHandshake(c *connection, d *bin.Decoder) error {
	// Connection context is embedded in connection struct
	// Use ctx as alias for readability
	ctx := c
	...
	case mt.ClazzID_req_pq:
		...
		return s.writeToConnection(c, x.Bytes())
