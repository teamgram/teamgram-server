...
func (q *sessionOutgoingQueue) AddRpcResultMsg(reqMsgId int64, result *mt.TLMessageRawData) *outboxMsg {
...
func (q *sessionOutgoingQueue) AddNotifyMsg(notifyId int64, confirm bool, msg *mt.TLMessageRawData) *outboxMsg {
	oMsg := new(outboxMsg)
	oMsg.msgId = notifyId
	oMsg.sent = 0
	if confirm {
...
func (q *sessionOutgoingQueue) AddPushUpdates(pushMsgId int64, result *mt.TLMessageRawData) *outboxMsg {
