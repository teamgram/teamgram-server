...
// ///////////////////////////////////////////////////////////////////////////////////////
func (c *session) checkContainer(ctx context.Context, msgId int64, seqno int32, container *mt.TLMsgContainer) int32 {
	...
	for _, v := range container.Messages {
		...
		if _, ok := v.Object.(*mt.TLMsgContainer); ok {
...
func (c *session) onNewSessionCreated(ctx context.Context, gatewayId string, msgId int64) {
	...
	_, _ = c.sendDirectToGateway(ctx, gatewayId, true, newSessionCreated, func(sentRaw *mt.TLMessageRawData) {
...
*/
func (c *session) onDestroyAuthKey(ctx context.Context, gatewayId string, msgId *inboxMsg, destroyAuthKey *mt.TLDestroyAuthKey) {
...
func (c *session) onPing(ctx context.Context, gatewayId string, msgId *inboxMsg, ping *mt.TLPing) {
...
func (c *session) onPingDelayDisconnect(ctx context.Context, gatewayId string, msgId *inboxMsg, pingDelayDisconnect *mt.TLPingDelayDisconnect) {
...
*/
func (c *session) onHttpWait(ctx context.Context, gatewayId string, msgId int64, seqNo int32, request *mt.TLHttpWait) {
...
func (c *session) onDestroySession(ctx context.Context, gatewayId string, msgId *inboxMsg, request *mt.TLDestroySession) {
...
func (c *session) onGetFutureSalts(ctx context.Context, gatewayId string, msgId *inboxMsg, request *mt.TLGetFutureSalts) {
...
func (c *session) onRpcDropAnswer(ctx context.Context, gatewayId string, msgId *inboxMsg, request *mt.TLRpcDropAnswer) {
	...
	//if !found {
	//	rpcAnswer.Constructor = mt.ClazzID_rpc_answer_unknown
	//}
