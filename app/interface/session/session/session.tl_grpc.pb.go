...
func (c *rPCSessionClient) SessionQueryAuthKey(ctx context.Context, in *TLSessionQueryAuthKey, opts ...grpc.CallOption) (*mtproto.AuthKeyInfo, error) {
	...
	err := c.cc.Invoke(ctx, RPCSession_SessionQueryAuthKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCSessionClient) SessionSetAuthKey(ctx context.Context, in *TLSessionSetAuthKey, opts ...grpc.CallOption) (*mtproto.Bool, error) {
	...
	err := c.cc.Invoke(ctx, RPCSession_SessionSetAuthKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRPCSessionServer should be embedded to have
...
func (UnimplementedRPCSessionServer) testEmbeddedByValue() {}
...
func RegisterRPCSessionServer(s grpc.ServiceRegistrar, srv RPCSessionServer) {
	// If the following call pancis, it indicates UnimplementedRPCSessionServer was
