...
func NewServer(handler gateway.RPCGateway, opts ...server.Option) server.Server {
...
func RegisterService(svr server.Server, handler gateway.RPCGateway, opts ...server.RegisterOption) error {
